      ...
      {!session ? (
        ...
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center px-8 max-w-4xl">
            {/* Welcome Message */}
            <div className="mb-12">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full shadow-2xl mb-8">
                <span className="text-white text-3xl font-bold">AOM</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <Link href="/dashboard" className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <p className="text-gray-400">View your progress and analytics</p>
                </div>
              </Link>
              ...
              <Link href="/quiz" className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-white font-semibold text-lg mb-2">Take Quiz</h3>
              ...
              <Link href="/notes" className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-white font-semibold text-lg mb-2">Study Notes</h3>
                  <p className="text-gray-400">Access study materials</p>
                </div>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/abbreviations" className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <h3 className="text-white font-semibold text-lg mb-2">Abbreviations</h3>
                  <p className="text-gray-400">Quick reference guide</p>
                </div>
              </Link>

              <Link href="/pdfs" className="group">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <h3 className="text-white font-semibold text-lg mb-2">PDF Resources</h3>
                  <p className="text-gray-400">Download study materials</p>
                </div>
              </Link>
            </div>
          </div>
