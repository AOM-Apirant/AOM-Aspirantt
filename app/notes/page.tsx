      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mt-12">
              ...
              <div className="space-y-8">
                ...
                <div className="border-l-4 border-green-500 pl-6">
                  ...
                  <p className="text-gray-700 mb-4">In these rules, unless the context otherwise requires:</p>
            ...
            <div className="mt-16 border-t-4 border-purple-500 pt-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
              ...
              <div className="mb-8">
                ...
                <div className="bg-purple-50 rounded-lg p-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-lg font-semibold text-purple-700 mb-2">Rajbhasha Definition</h4>
                      <p className="text-gray-700">Official Language (Raj Bhasha) means the language to be used for official transaction. According to constitutional provisions Hindi in Devanagari script is the official language and English is an associate language.</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold text-purple-700 mb-2">Article 343(1) Provisions</h4>
              ...
              <div className="mb-8">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  <div className="space-y-4">
                    <p className="text-gray-700">As per Article 343(1) of the constitution of India, the Official language of the Union shall be in Hindi in Devanagari script. Article 343(2) empowers the President of India to authorize the use of the Hindi language in addition to the English language.</p>
                    
                    <div>
                      <h4 className="text-lg font-semibold text-blue-700 mb-3">Key Provisions of the Act:</h4>
                      <ul className="space-y-2 text-gray-700">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="bg-green-50 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-green-700 mb-3">Key Features (1-4)</h4>
                  ...
                  <div className="bg-orange-50 rounded-lg p-6">
                    <h4 className="text-lg font-semibold text-orange-700 mb-3">Key Features (5-8)</h4>
                    <ul className="space-y-2 text-gray-700 text-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    <h4 className="text-lg font-semibold text-green-700 mb-3 flex items-center">
                      <span className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-2">A</span>
                      Region A (K Kshetra)
                    </h4>
                    <p className="text-gray-700 text-sm">Bihar, Haryana, Himachal Pradesh, Rajasthan, Madhya Pradesh, Uttar Pradesh, Delhi, Chhattisgarh, Jharkhand, Uttarakhand and Andaman and Nicobar Islands</p>
                  </div>

                  {/* Region B */}
                  <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-lg">
                    <h4 className="text-lg font-semibold text-orange-700 mb-3 flex items-center">
                      <span className="w-6 h-6 bg-orange-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-2">B</span>
                      Region B (Kha Kshetra)
                    </h4>
                    <p className="text-gray-700 text-sm">Gujarat, Maharashtra, Punjab and Union Territory of Chandigarh</p>
                  </div>

                  {/* Region C */}
                  <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-lg">
                    <h4 className="text-lg font-semibold text-red-700 mb-3 flex items-center">
                      <span className="w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-2">C</span>
                      Region C (Ga Kshetra)
                    </h4>
                    <p className="text-gray-700 text-sm">All other states and UTs: J&K, Assam, Nagaland, Manipur, Mizoram, Tripura, Arunachal Pradesh, Meghalaya, Sikkim, Andhra Pradesh, Tamil Nadu, Karnataka, Kerala, Goa, Daman and Diu, Lakshadweep, Pondicherry</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-yellow-50 rounded-lg p-6">
                  <p className="text-gray-700 mb-4">Section 3(3) of the Act is about the bilingual use in important places. According to this section, the use of Hindi and English both is compulsory. Hindi should be bold and used before or above English.</p>
                  
                  <div>
                    <h4 className="text-lg font-semibold text-yellow-700 mb-3">Documents under Section 3(3):</h4>
                    <ul className="space-y-2 text-gray-700">
              ...
              <div className="mb-8">
                ...
                {/* Personal Pay */}
                <div className="mb-6">
                  <h4 className="text-xl font-semibold text-green-700 mb-3">A. Personal Pay Benefits</h4>
                  <div className="bg-green-50 rounded-lg p-4">
                    <p className="text-gray-700 mb-3">Benefit of personal Pay equal to the amount of one Increment for 12 months for:</p>
                ...
                {/* Cash Awards */}
                <div className="mb-6">
                  <h4 className="text-xl font-semibold text-blue-700 mb-3">B. Cash Awards</h4>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="text-left p-2">Pragya</th>
                            <th className="text-left p-2">Praveen</th>
                            <th className="text-left p-2">Prabodh</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-b">
                            <td className="p-2">70% or more</td>
                            <td className="p-2">Rs. 2400/-</td>
                            <td className="p-2">Rs. 1800/-</td>
                            <td className="p-2">Rs. 1600/-</td>
                          </tr>
                          <tr className="border-b">
                            <td className="p-2">60% or more</td>
                            <td className="p-2">Rs. 1600/-</td>
                            <td className="p-2">Rs. 1200/-</td>
                            <td className="p-2">Rs. 800/-</td>
                          </tr>
                          <tr>
                            <td className="p-2">55% or more</td>
                            <td className="p-2">Rs. 800/-</td>
                            <td className="p-2">Rs. 600/-</td>
                ...
                {/* Other Incentives */}
                <div className="mb-6">
                  <h4 className="text-xl font-semibold text-purple-700 mb-3">C. Other Incentives</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-purple-50 rounded-lg p-4">
                      <h5 className="font-semibold text-purple-700 mb-2">Essay & Speech Competitions</h5>
                      <ul className="space-y-1 text-gray-700 text-sm">
                    ...
                    <div className="bg-indigo-50 rounded-lg p-4">
                      <h5 className="font-semibold text-indigo-700 mb-2">Noting & Drafting Competition</h5>
                      <ul className="space-y-1 text-gray-700 text-sm">
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-lg font-semibold text-gray-700 mb-3">Administrative Responsibilities</h4>
                      <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-700 mb-3">Operational Activities</h4>
                      <ul className="space-y-2 text-gray-700 text-sm">
