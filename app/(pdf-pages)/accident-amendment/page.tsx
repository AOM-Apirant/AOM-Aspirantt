...
import { accidentPdfFiles } from '@/assets/pdf'

const AccidentAmendments = () => {
  const handleDownload = (filename: string) => {
    const link = document.createElement('a')
    link.href = `/ampdfs/${filename}`
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-orange-600 mx-auto mt-6 rounded-full"></div>
        </div>
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="p-3 bg-gradient-to-r from-red-500 to-orange-600 rounded-lg mr-4">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center group"
                  >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 to-orange-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              </div>
            )
          })}
        </div>
...
export default AccidentAmendments