...
import ConductRules1966Rule2 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule2'
import ConductRules1966Rule3 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule3'
import ConductRules1966Rule4 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule4'
import ConductRules1966Rule5 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule5'
import ConductRules1966Rule6 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule6'
import ConductRules1966Rule7 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule7'
import ConductRules1966Rule8 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule8'
import ConductRules1966Rule9 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule9'
import ConductRules1966Rule10 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule10'
import ConductRules1966Rule11 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule11'
import ConductRules1966Rule12 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule12'
import ConductRules1966Rule13 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule13'
import ConductRules1966Rule14 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule14'
import ConductRules1966Rule15 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule15'
import ConductRules1966Rule16 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule16'
import ConductRules1966Rule17 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule17'
import ConductRules1966Rule18 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule18'
import ConductRules1966Rule19 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule19'
import ConductRules1966Rule20 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule20'
import ConductRules1966Rule21 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule21'
import ConductRules1966Rule22 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule22'
import ConductRules1966Rule23 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule23'
import ConductRules1966Rule24 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule24'
import ConductRules1966Rule25 from '@/components/conduct-rules-1966/conduct-rules-1966-index-topics/ConductRules1966Rule25'
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 flex items-center justify-center">
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <button
              onClick={() => router.push('/conduct-rules')}
        ...
        <div className="mt-6 mb-6 p-3 bg-white/10 backdrop-blur-lg rounded-lg border border-white/20">
          <div className="flex items-center justify-between space-x-8">
            <button
              onClick={() => {
                if (prevRule !== null) {
                  router.push(`/conduct-rules/content/${prevRule}`)
                }
              }}
              disabled={!hasPrev}
            ...
            <button
              onClick={() => {
                if (nextRule !== null) {
                  router.push(`/conduct-rules/content/${nextRule}`)
                }
              }}
              disabled={!hasNext}
              className={`flex flex-col items-center space-y-1 px-3 py-2 rounded-sm text-white transition-all duration-300 ${
