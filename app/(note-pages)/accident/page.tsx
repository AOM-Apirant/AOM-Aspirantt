...
import AMChapters from '@/components/acc-manual/AMChapters'
import AMAppendix from '@/components/acc-manual/AMAppendix'
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-2 border border-white/20">
              <h2 className="lg:text-3xl text-xl font-bold text-white mb-8 flex flex-col lg:flex-row gap-4 items-center justify-center">
                <span className="bg-gradient-to-r from-gray-500 to-slate-500 lg:p-4 p-2 rounded-full mr-4 shadow-lg">
                  <svg className="lg:w-8 lg:h-8 w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gradient-to-br from-gray-500/20 to-slate-500/20 backdrop-blur-lg rounded-xl py-4 lg:px-4 px-2 shadow-lg border border-gray-400/30 hover:shadow-xl transition-all duration-300">
                <div className="text-center space-y-4 flex flex-col">
                  ...
                  <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-sm rounded-lg p-4 inline-block">
                    <p className="text-white font-bold lg:text-2xl text-xl">CHIEF OPERATIONS MANAGER</p>
                  </div>
                  <div className="bg-gradient-to-r from-orange-500/20 to-amber-500/20 backdrop-blur-sm rounded-lg p-4 inline-block">
