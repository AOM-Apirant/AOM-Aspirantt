      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-purple-400 mr-1 text-lg font-bold min-w-[3rem]">1.</span>
                    <span className="text-gray-200">Short title, extent and commencement</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-purple-400 mr-1 text-lg font-bold min-w-[3rem]">2.</span>
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">3.</span>
                    <span className="text-gray-200">Appointment of Registrars</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">4.</span>
                    <span className="text-gray-200">Mode of registration</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">5.</span>
                    <span className="text-gray-200">Application for registration</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">6.</span>
                    <span className="text-gray-200">Provisions to be contained in the rules of a Trade Union</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">7.</span>
                    <span className="text-gray-200">Power to call for further particulars and to require alteration of name</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">8.</span>
                    <span className="text-gray-200">Registration</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">9.</span>
                    <span className="text-gray-200">Certificate of registration</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">10.</span>
                    <span className="text-gray-200">Cancellation of registration</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">11.</span>
                    <span className="text-gray-200">Appeal</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">12.</span>
                    <span className="text-gray-200">Registered office</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">13.</span>
                    <span className="text-gray-200">Incorporation of registered Trade Unions</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-blue-400 mr-1 text-lg font-bold min-w-[3rem]">14.</span>
              ...
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-green-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">15.</span>
                    <span className="text-gray-200">Objects on which general funds may be spent</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">16.</span>
                    <span className="text-gray-200">Constitution of a separate fund for political purposes</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">17.</span>
                    <span className="text-gray-200">Criminal conspiracy in trade disputes</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">18.</span>
                    <span className="text-gray-200">Immunity from civil suit in certain cases</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">19.</span>
                    <span className="text-gray-200">Enforceability of agreements</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">20.</span>
                    <span className="text-gray-200">Right to inspect books of Trade Union</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">21.</span>
                    <span className="text-gray-200">Rights of minors to membership of Trade Unions</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">21A.</span>
                    <span className="text-gray-200">Disqualifications of office-bearers of Trade Unions</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">22.</span>
                    <span className="text-gray-200">Proportion of office-bearers to be connected with the industry</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-4 mt-1 text-lg font-bold min-w-[3rem]">23.</span>
                    <span className="text-gray-200">Change of name</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">24.</span>
                    <span className="text-gray-200">Amalgamation of Trade Unions</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">25.</span>
                    <span className="text-gray-200">Notice of change of name or amalgamation</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">26.</span>
                    <span className="text-gray-200">Effects of change of name and of amalgamation</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">27.</span>
                    <span className="text-gray-200">Dissolution</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-green-400 mr-1 text-lg font-bold min-w-[3rem]">28.</span>
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-orange-400 mr-1 text-lg font-bold min-w-[3rem]">29.</span>
                    <span className="text-gray-200">Power to make regulations</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-orange-400 mr-1 text-lg font-bold min-w-[3rem]">30.</span>
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="space-y-1">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-pink-400 mr-1 text-lg font-bold min-w-[3rem]">31.</span>
                    <span className="text-gray-200">Failure to submit returns</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-pink-400 mr-1 text-lg font-bold min-w-[3rem]">32.</span>
                    <span className="text-gray-200">Supplying false information regarding Trade Unions</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                    <span className="text-pink-400 mr-1 text-lg font-bold min-w-[3rem]">33.</span>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-2 mb-6 border border-white/20">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-2 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-4 border border-white/20">
            <div className="text-center">
              <div className="inline-block lg:p-4 p-2 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-full mb-6 backdrop-blur-sm">
                <div className="bg-gradient-to-r from-emerald-500 to-teal-600 lg:p-4 p-2 rounded-full">
              ...
              <button
                ...
                className="group relative inline-flex items-center justify-center px-10 py-3 lg:px-12 lg:py-5 text-lg lg:text-xl font-bold text-white bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 border-2 border-emerald-400/50 hover:border-emerald-300/70 backdrop-blur-sm"
              >
                <svg className="w-6 h-6 mr-3 group-hover:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Download PDF
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-300"></div>
              </button>
...
export default TheTradeUnionAct1926