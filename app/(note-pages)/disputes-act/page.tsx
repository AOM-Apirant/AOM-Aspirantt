        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 px-2 mb-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3 flex items-center">
              ...
              <div className="bg-gradient-to-br from-rose-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-rose-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3 flex items-center">
                  <span className="w-3 h-3 bg-gradient-to-br from-rose-500 to-red-500 rounded-full mr-3 animate-pulse"></span>
                  Labour Courts
                </h3>
                <p className="text-gray-200 text-sm">
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3 flex items-center">
