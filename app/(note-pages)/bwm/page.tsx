...
import BWMPartA from '@/components/bwm/BWMPartA'
import BWMPartB from '@/components/bwm/BWMPartB'
import BWMPartC from '@/components/bwm/BWMPartC'
import BWMAnnexureOne from '@/components/bwm/BWMAnnexureOne'
import BWMAnnexure from '@/components/bwm/BWMAnnexure'
    ...
    <div className='min-h-screen bg-slate-900 text-white'>
      <div className='bg-gradient-to-r from-slate-800 via-blue-900 to-slate-800 py-16'>
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
            ...
            <div className='bg-gradient-to-br from-orange-600/20 to-red-600/20 rounded-xl p-6 border border-orange-500/30 hover:border-orange-400/50 transition-all duration-300'>
              <div className='text-center'>
          ...
          <div className='text-center mb-8'>
            <div className='inline-block bg-gradient-to-r from-yellow-500/20 to-orange-500/20 px-6 py-3 rounded-full border border-yellow-500/30'>
      ...
      <div className='py-16 bg-gradient-to-r from-slate-900 to-slate-800'>
        <div className='max-w-4xl mx-auto px-4'>
          <div className='bg-gradient-to-r from-slate-800/50 to-blue-900/50 rounded-2xl p-8 border border-slate-700/50 shadow-2xl'>
