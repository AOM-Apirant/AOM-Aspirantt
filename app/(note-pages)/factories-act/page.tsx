        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-2 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-xl p-4 text-white hover:scale-105 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-4 text-white hover:scale-105 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl p-4 text-white hover:scale-105 transition-all duration-300">
                <div className="text-2xl mb-2">🏥</div>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl p-4 text-white hover:scale-105 transition-all duration-300">
                <div className="text-2xl mb-2">⚖️</div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-2 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Health */}
              <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
              ...
              {/* Safety */}
              <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-4 flex items-center">
              ...
              {/* Welfare */}
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-4 flex items-center">
                  <span className="mr-2">❤️</span>
                  Welfare
                </h3>
              ...
              {/* Working Hours */}
              <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-4 flex items-center">
                  <span className="mr-2">⏰</span>
                  Working Hours
                </h3>
              ...
              <div className="bg-gradient-to-br from-pink-600 to-pink-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-4 flex items-center">
                  <span className="mr-2">👥</span>
                  Women & Children
                </h3>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-xl p-6 text-white hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-4 flex items-center">
                  <span className="mr-2">📋</span>
                  Registration
                </h3>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-2 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                    ...
                    <h3 className="text-blue-300 font-bold mb-3 text-sm">{chapter.title}</h3>
                       ...
                       {chapter.sections.map((section, sectionIndex) => (
                         <li key={sectionIndex} className="text-gray-300 text-xs flex items-start group hover:bg-white/5 p-1 rounded transition-all duration-200">
                           <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mr-3 text-white text-xs font-bold shadow-lg group-hover:scale-110 transition-transform">
                             {section.number}
                           </span>
           ...
           <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-6 px-2 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
             ...
             <div className="grid md:grid-cols-3 gap-6">
               <div className="text-center group hover:scale-105 transition-all duration-300 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-8 px-4 border border-white/20 hover:bg-white/15">
                 <div className="bg-gradient-to-br from-blue-500 to-blue-600 lg:text-4xl text-2xl font-bold p-6 rounded-full lg:w-24 lg:h-24 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-2xl group-hover:shadow-blue-500/50 transition-shadow">
                   ⚖️
                 </div>
               ...
               <div className="text-center group hover:scale-105 transition-all duration-300 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-8 px-4 border border-white/20 hover:bg-white/15">
                 <div className="bg-gradient-to-br from-green-500 to-green-600 lg:text-4xl text-2xl font-bold p-6 rounded-full lg:w-24 lg:h-24 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-2xl group-hover:shadow-green-500/50 transition-shadow">
                   🛡️
                 </div>
               ...
               <div className="text-center group hover:scale-105 transition-all duration-300 bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl py-8 px-4 border border-white/20 hover:bg-white/15">
                 <div className="bg-gradient-to-br from-purple-500 to-purple-600 lg:text-4xl text-2xl font-bold p-6 rounded-full lg:w-24 lg:h-24 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-2xl group-hover:shadow-purple-500/50 transition-shadow">
                   🌍
                 </div>
           ...
           <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 lg:px-8 px-4 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
             <div className="text-center">
               <div className="inline-block lg:p-4 p-2 bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-full mb-6 backdrop-blur-sm">
               ...
               >
                 <span className="absolute inset-0 bg-gradient-to-r from-red-600 to-orange-700 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
