...
import OMPage1 from '@/components/optg-manual/optg-manual-index-pages/OMPage1'
import OMPage3 from '@/components/optg-manual/optg-manual-index-pages/OMPage3'
import OMPage7 from '@/components/optg-manual/optg-manual-index-pages/OMPage7'
import OMPage8 from '@/components/optg-manual/optg-manual-index-pages/OMPage8'
import OMPage10 from '@/components/optg-manual/optg-manual-index-pages/OMPage10'
import OMPage12 from '@/components/optg-manual/optg-manual-index-pages/OMPage12'
import OMPage15 from '@/components/optg-manual/optg-manual-index-pages/OMPage15'
import OMPage20 from '@/components/optg-manual/optg-manual-index-pages/OMPage20'
import OMPage29 from '@/components/optg-manual/optg-manual-index-pages/OMPage29'
import OMPage31 from '@/components/optg-manual/optg-manual-index-pages/OMPage31'
import OMPage39 from '@/components/optg-manual/optg-manual-index-pages/OMPage39'
import OMPage42 from '@/components/optg-manual/optg-manual-index-pages/OMPage42'
import OMPage46 from '@/components/optg-manual/optg-manual-index-pages/OMPage46'
import OMPage47 from '@/components/optg-manual/optg-manual-index-pages/OMPage47'
import OMPage51 from '@/components/optg-manual/optg-manual-index-pages/OMPage51'
import OMPage53 from '@/components/optg-manual/optg-manual-index-pages/OMPage53'
import OMPage54 from '@/components/optg-manual/optg-manual-index-pages/OMPage54'
import OMPage56 from '@/components/optg-manual/optg-manual-index-pages/OMPage56'
import OMPage59 from '@/components/optg-manual/optg-manual-index-pages/OMPage59'
import OMPage61 from '@/components/optg-manual/optg-manual-index-pages/OMPage61'
import OMPage62 from '@/components/optg-manual/optg-manual-index-pages/OMPage62'
import OMPage66 from '@/components/optg-manual/optg-manual-index-pages/OMPage66'
import OMPage73 from '@/components/optg-manual/optg-manual-index-pages/OMPage73'
import OMPage75 from '@/components/optg-manual/optg-manual-index-pages/OMPage75'
import OMPage78 from '@/components/optg-manual/optg-manual-index-pages/OMPage78'
import OMPage79 from '@/components/optg-manual/optg-manual-index-pages/OMPage79'
import OMPage81 from '@/components/optg-manual/optg-manual-index-pages/OMPage81'
import OMPage82 from '@/components/optg-manual/optg-manual-index-pages/OMPage82'
import OMPage83 from '@/components/optg-manual/optg-manual-index-pages/OMPage83'
import OMPage85 from '@/components/optg-manual/optg-manual-index-pages/OMPage85'
import OMPage86 from '@/components/optg-manual/optg-manual-index-pages/OMPage86'
import OMPage87 from '@/components/optg-manual/optg-manual-index-pages/OMPage87'
import OMPage89 from '@/components/optg-manual/optg-manual-index-pages/OMPage89'
import OMPage91 from '@/components/optg-manual/optg-manual-index-pages/OMPage91'
import OMPage92 from '@/components/optg-manual/optg-manual-index-pages/OMPage92'
import OMPage95 from '@/components/optg-manual/optg-manual-index-pages/OMPage95'
import OMPage97 from '@/components/optg-manual/optg-manual-index-pages/OMPage97'
import OMPage98 from '@/components/optg-manual/optg-manual-index-pages/OMPage98'
import OMPage102 from '@/components/optg-manual/optg-manual-index-pages/OMPage102'
import OMPage105 from '@/components/optg-manual/optg-manual-index-pages/OMPage105'
import OMPage106 from '@/components/optg-manual/optg-manual-index-pages/OMPage106'
import OMPage109 from '@/components/optg-manual/optg-manual-index-pages/OMPage109'
import OMPage112 from '@/components/optg-manual/optg-manual-index-pages/OMPage112'
import OMPage113 from '@/components/optg-manual/optg-manual-index-pages/OMPage113'
import OMPage115 from '@/components/optg-manual/optg-manual-index-pages/OMPage115'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900"> 
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-2 left-2 bg-gradient-to-tr from-blue-600 via-blue-400 to-blue-700 text-white p-1 rounded-full shadow-2xl border-2 border-white hover:scale-110 hover:from-blue-700 hover:to-blue-500 transition-all duration-300 z-50 flex items-center justify-center animate-pulse"
