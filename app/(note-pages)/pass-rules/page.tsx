      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <section className="bg-gradient-to-br from-emerald-50 to-teal-100 rounded-xl shadow-xl p-8 mb-8 border-2 border-emerald-200">
         ...
         <section className="bg-gradient-to-br from-cyan-50 to-blue-100 rounded-xl shadow-xl p-8 mb-8 border-2 border-cyan-200">
           <div className="flex items-center mb-8">
             <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mr-6 shadow-lg">
               <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
               </svg>
             </div>
           ...
           <div className="bg-white rounded-xl p-6 shadow-md border border-cyan-200 mb-8">
             <p className="text-gray-700 leading-relaxed">
               A special pass may be issued to Railway servants, family members or dependent relatives as the case may be, on various grounds including medical, sports, official duties, and other special circumstances.
             </p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
               ...
               <p className="text-gray-700 text-sm">For medical treatment and health-related travel</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
               ...
               <p className="text-gray-700 text-sm">For participation in sports activities and competitions</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">RRB/Selection Board</h4>
               </div>
               <p className="text-gray-700 text-sm">For appearing before RRB/Selection Board while on leave or on duty</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Disciplinary Enquiries</h4>
               </div>
               <p className="text-gray-700 text-sm">For attending departmental disciplinary enquiries and for inspection of documents</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-teal-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Complainant&apos;s Enquiry</h4>
               </div>
               <p className="text-gray-700 text-sm">For attending complainant&apos;s enquiry</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Appellate Authority</h4>
               </div>
               <p className="text-gray-700 text-sm">For personal hearing of the Appellate Authority</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-500">
               ...
               <p className="text-gray-700 text-sm">Office bearer and representative of recognised railway unions and of the Federation for whom grant of Pass is governed by the instructions issued by Railway Board from time to time</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Staff Benefit Fund</h4>
               </div>
               <p className="text-gray-700 text-sm">Members of Staff Benefit Fund Committee etc.</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-cyan-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Special Class Railway Apprentices</h4>
               </div>
               <p className="text-gray-700 text-sm">For Special Class Railway Apprentices</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-emerald-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Other Apprentices</h4>
               </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-rose-500">
               ...
               <p className="text-gray-700 text-sm">For Scout and Guide activities</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-violet-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">St. John&apos;s Ambulance</h4>
               </div>
               <p className="text-gray-700 text-sm">For St. John&apos;s Ambulance Brigade</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-amber-500">
               ...
               <p className="text-gray-700 text-sm">To receive settlement dues</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-lime-500">
               ...
               <p className="text-gray-700 text-sm">For motor vehicle related travel</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-sky-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">First Appointment</h4>
               </div>
               <p className="text-gray-700 text-sm">On First appointment to Railway Service</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-slate-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Retirement/Decease</h4>
               </div>
               <p className="text-gray-700 text-sm">On retirement/decease - grant of settlement pass</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-stone-500">
               ...
               <p className="text-gray-700 text-sm">For enquiries by Commissioners for Railway Safety</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-neutral-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Quasi Railway Institutions</h4>
               </div>
               <p className="text-gray-700 text-sm">To staff of quasi Railway Institutions</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-zinc-500">
               ...
               <p className="text-gray-700 text-sm">Railway servants under suspension</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-gray-500">
               ...
               <p className="text-gray-700 text-sm">Attending conferences, congresses or meetings</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Territorial Army</h4>
               </div>
               <p className="text-gray-700 text-sm">Family passes to Territorial Army Personnel proceeding to camps</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-600">
               ...
               <p className="text-gray-700 text-sm">Candidates summoned for test/interview by Railway Recruitment Boards and Railway Administrations</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Children&apos;s Camps</h4>
               </div>
               <p className="text-gray-700 text-sm">Journeys in connection with children&apos;s camps</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Cultural Activities</h4>
               </div>
               <p className="text-gray-700 text-sm">Attending cultural activities etc.</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Railway User&apos;s Committees</h4>
               </div>
               <p className="text-gray-700 text-sm">Passes to members of Railway User&apos;s Consultative Committees, National Railway User&apos;s Consultative Council</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-teal-600">
               ...
               <p className="text-gray-700 text-sm">Passes for families of reservists</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Retired Railway Servants</h4>
               </div>
               <p className="text-gray-700 text-sm">Retired Railway servants for perusal of documents for preparation of his Defence in disciplinary case instituted against him</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Medically Decategorised</h4>
               </div>
               <p className="text-gray-700 text-sm">Medically decategorised staff when called for adjudging their suitability for alternative appointment</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Retired Railway Servant Assistance</h4>
               </div>
               <p className="text-gray-700 text-sm">To retired Railway servant for assistance to defend a Railway servant involved in disciplinary proceedings, to attend any meeting of a commission of enquiry or of a Board, Conference, Committee, or departmental enquiry convened under proper authority or is required to perform any public duty in an honorary capacity</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-cyan-600">
               ...
               <p className="text-gray-700 text-sm">To Casual Labour on recruitment/discharge</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-emerald-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Railway Accidents</h4>
               </div>
               <p className="text-gray-700 text-sm">Complimentary passes to next of kin of the victims as well as to the surviving victims involved in Railway accidents</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-rose-600">
               ...
               <p className="text-gray-700 text-sm">RPF Dogs with Handler/Inspectors</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-amber-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Visiting Lecturer</h4>
               </div>
               <p className="text-gray-700 text-sm">Grant of I AC Complimentary Pass to the visiting Lecturer of a appropriate status</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-lime-600">
               ...
               <p className="text-gray-700 text-sm">Whole time employees of the Zonal Recognised Unions and Federations</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-sky-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Railway Magistrates</h4>
               </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-slate-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Government Railway Police</h4>
               </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-stone-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Workers Education</h4>
               </div>
               <p className="text-gray-700 text-sm">Participants in Workers Education Programmes Conducted by AIRF/NFIR in the Zonal Headquarters Station/Divl. Headquarters Station/Centralised Training Institutes</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-neutral-600">
               ...
               <p className="text-gray-700 text-sm">Rail travel facilities to MR/MOS(R)/DMR</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-gray-600">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Railway Claims Tribunal</h4>
               </div>
               <p className="text-gray-700 text-sm">Claimant before Railway Claims Tribunal</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-700">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Railway Inquiry Officers</h4>
               </div>
               <p className="text-gray-700 text-sm">Retired Railway Officers of Selection Grade and above who are empanelled as Railway Inquiry Officers in D&AR cases to undertake journey either for conduct of inquiry or for training or any other official purpose in this connection</p>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-700">
               ...
               <p className="text-gray-700 text-sm">Doctors/para medical staff invited in connection with blood donation/eye testing camps being organised on the Railways</p>
             </div>
           </div>
           ...
           <div className="space-y-6">
             <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Special passes are issued based on specific circumstances and requirements</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Each ground has specific eligibility criteria and documentation requirements</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Passes must be properly authorized and signed by competent authority</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Validity periods may vary based on the purpose of travel</p>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">1</div>
                   <span>Submit application with supporting documents</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">2</div>
                   <span>Get approval from competent authority</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">3</div>
                   <span>Collect pass from issuing office</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">4</div>
           ...
           <div className="mt-8 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl p-6 text-white">
             <div className="flex items-center justify-between">
               <div className="flex items-center">
                 ...
                 <div>
                   <h4 className="text-lg font-semibold">Special Pass Assistance</h4>
                   <p className="text-cyan-100">Contact your department for special pass applications and documentation</p>
                 </div>
               </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
               ...
               <div className="space-y-3 text-gray-700">
                 <p className="text-sm"><strong>Class:</strong> 1st Class/2nd AC</p>
                 <p className="text-sm"><strong>Companion:</strong> Allowed in same class</p>
                 <p className="text-sm"><strong>Restrictions:</strong> Any train other than Rajdhani/Shatabdi trains</p>
                 <p className="text-sm"><strong>Coverage:</strong> All Indian Railways [except Metro Railway/Kolkata]</p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-pink-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Rajdhani/Shatabdi Trains</h4>
               </div>
               <div className="space-y-3 text-gray-700">
                 <p className="text-sm"><strong>Rajdhani:</strong> 3rd AC</p>
                 <p className="text-sm"><strong>Shatabdi/Jan Shatabdi:</strong> Chair Car [CC]</p>
                 <p className="text-sm"><strong>Companion:</strong> Allowed in same class</p>
                 <p className="text-sm"><strong>Note:</strong> Special stamping required</p>
               </div>
             </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
               ...
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Persons:</strong> Two persons (self and companion)</p>
                 <p className="text-sm"><strong>Duration:</strong> Life-time basis</p>
                 <p className="text-sm"><strong>Renewal:</strong> Every year</p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
               ...
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Grant Period:</strong> One year</p>
                 <p className="text-sm"><strong>Renewal:</strong> Annual renewal required</p>
                 <p className="text-sm"><strong>Validity:</strong> Continuous lifetime benefit</p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Issuing Authority</h4>
               </div>
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Location:</strong> Divisional/Zonal Headquarters only</p>
                 <p className="text-sm"><strong>Restriction:</strong> Cannot be issued at other offices</p>
                 <p className="text-sm"><strong>Centralized:</strong> Controlled issuance</p>
               </div>
             </div>
           </div>
           ...
           <div className="space-y-6">
             <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Passes are valid for lifetime but require annual renewal</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                 ...
                 <div className="flex items-start">
                   <span className="text-blue-500 mr-3 mt-1">•</span>
                   <p>Special stamping is mandatory for Rajdhani/Shatabdi travel</p>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">1</div>
                   <span>Submit application with freedom fighter certificate</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">2</div>
           ...
           <div className="mt-8 bg-gradient-to-r from-red-500 to-pink-600 rounded-xl p-6 text-white">
             <div className="flex items-center justify-between">
               <div className="flex items-center">
                 ...
                 <div>
                   <h4 className="text-lg font-semibold">Freedom Fighter Pass Assistance</h4>
                   <p className="text-red-100">Contact Divisional/Zonal Headquarters for freedom fighter pass applications</p>
                 </div>
               </div>
           ...
           <div className="flex items-center mb-8">
             ...
             <div>
               ...
               <p className="text-gray-600 font-medium">
                 Special provisions for suspended employees and route restrictions
               </p>
             </div>
           </div>
           ...
           <div className="mb-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
                 ...
                 <div className="space-y-3 text-gray-700">
                   <p className="text-sm"><strong>Group C & D:</strong> Not more than one set of Pass</p>
                   ...
                   <p className="text-sm"><strong>Retention:</strong> If retained in service after release from suspension, passes issued during suspension period within current calendar year shall be debited to pass account.</p>
                 </div>
               </div>
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
                 ...
                 <div className="space-y-3 text-gray-700">
                   <p className="text-sm"><strong>Limit:</strong> Not more than 2 sets per year</p>
                   <p className="text-sm"><strong>Stipulations:</strong> Other stipulations similar to those for passes shall also apply</p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 ...
                 <div className="space-y-3 text-gray-700">
                   ...
                   <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                     <p className="text-xs text-gray-700">
                       ...
                       • Bombay to Calcutta via Nagpur or via Allahabad<br/>
                       • Bombay to Delhi by Central Railway or Western Railway
                     </p>
                   </div>
                   <p className="text-sm"><strong>Condition:</strong> Such passes may be permitted by either route irrespective of the distance involved</p>
                 </div>
               </div>
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                 <div className="flex items-center mb-4">
                   ...
                   <h4 className="font-semibold text-gray-800">15% Distance Rule</h4>
                 </div>
                 <div className="space-y-3 text-gray-700">
                   ...
                   <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                     <p className="text-xs text-gray-700">
                       <strong>Examples:</strong><br/>
                       • Chittaranjan to Kancharapara via Howrah<br/>
                       • Lucknow to Southern/South Central Railway via Bombay V.T.
                     </p>
                   </div>
                   <p className="text-sm"><strong>Condition:</strong> Even if double journey over small portion is involved, provided distance doesn&apos;t exceed shortest route by more than 15%</p>
                 </div>
               </div>
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                 ...
                 <div className="space-y-3 text-gray-700">
                   ...
                   <p className="text-sm"><strong>Benefit:</strong> To take advantage of terminal facilities as in Bombay V.T.-Kalyan or Madras-Arkonam sections</p>
                 </div>
               </div>
             </div>
           </div>
           ...
           <div className="space-y-6">
             <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-start">
                   ...
                   <p>Suspension passes are strictly limited and subject to remaining pass balance</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>Distance restrictions ensure optimal route usage while allowing flexibility</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>15% rule allows for practical route choices considering terminal facilities</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>Quicker route option prioritizes time efficiency over distance</p>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
               ...
               <div className="space-y-4 text-gray-700">
                 ...
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">2</div>
                   <span>Specify preferred route with justification</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">3</div>
                   <span>Provide distance calculations if longer route requested</span>
                 </div>
                 <div className="flex items-center">
                   <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center mr-4 text-white font-bold">4</div>
           ...
           <div className="mt-8 bg-gradient-to-r from-gray-500 to-slate-600 rounded-xl p-6 text-white">
             <div className="flex items-center justify-between">
               <div className="flex items-center">
                 ...
                 <div>
                   <h4 className="text-lg font-semibold">Suspension & Route Assistance</h4>
                   <p className="text-gray-100">Contact your department for suspension passes and route-related queries</p>
                 </div>
               </div>
         ...
         <section className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-xl shadow-xl p-8 mb-8 border-2 border-teal-200">
           ...
           <div className="bg-white rounded-xl p-6 shadow-md border border-teal-200 mb-8">
             <p className="text-gray-700 leading-relaxed">
               Year-ending passes on privilege or PRC account can be issued during the next FIVE months of the following year with specific validity and advance issuance rules.
             </p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-teal-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Privilege/PRC Passes</h4>
               </div>
               <div className="space-y-3 text-gray-700">
                 <p className="text-sm"><strong>Issuance Period:</strong> Next FIVE months of following year</p>
                 <p className="text-sm"><strong>Validity:</strong> Not beyond 31st MAY of following year</p>
                 <div className="bg-teal-50 rounded-lg p-3 border border-teal-200">
                   <p className="text-xs text-gray-700">
                     <strong>Note:</strong> This procedure applies to both privilege and PRC account passes
                   </p>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-cyan-500">
               ...
               <div className="space-y-3 text-gray-700">
                 ...
                 <div className="bg-cyan-50 rounded-lg p-3 border border-cyan-200">
                   <p className="text-xs text-gray-700">
                     <strong>Condition:</strong> Subject to same validity restrictions as passes
                   </p>
                 </div>
               </div>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                 <div className="flex items-center mb-4">
                   ...
                   <h4 className="font-semibold text-gray-800">Regular Passes/PTOs</h4>
                 </div>
                 <div className="space-y-3 text-gray-700">
                   <p className="text-sm"><strong>Eligibility:</strong> When employee has availed all passes due in calendar year</p>
                   <p className="text-sm"><strong>Issue:</strong> One set of passes and/or one set of PTO</p>
                   <p className="text-sm"><strong>Journey:</strong> For journeys commencing in next year only</p>
                   <p className="text-sm"><strong>Debit:</strong> To next year&apos;s pass account</p>
                   <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                     <p className="text-xs text-gray-700">
                       <strong>Validity:</strong> Should not exceed FIVE months from date of issue
                     </p>
                   </div>
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                 <div className="flex items-center mb-4">
                   ...
                   <h4 className="font-semibold text-gray-800">PRC/Widow Passes</h4>
                 </div>
                 <div className="space-y-3 text-gray-700">
                   <p className="text-sm"><strong>Eligibility:</strong> Retired railway servant on request</p>
                   <p className="text-sm"><strong>Issue:</strong> One set of PRC Pass/Widow Pass in advance</p>
                   <p className="text-sm"><strong>Period:</strong> Current calendar year from date of issue</p>
                   <p className="text-sm"><strong>Journey:</strong> For journeys commencing in next year</p>
                   <p className="text-sm"><strong>Debit:</strong> To next year&apos;s account</p>
                   <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
                     <p className="text-xs text-gray-700">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
               ...
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Maximum:</strong> 31st MAY of following year</p>
                 <p className="text-sm"><strong>Advance Issue:</strong> FIVE months from date of issue</p>
                 <p className="text-sm"><strong>Extension:</strong> Not permitted beyond specified period</p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Issuance Conditions</h4>
               </div>
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Regular:</strong> All passes availed in calendar year</p>
                 <p className="text-sm"><strong>PRC/Widow:</strong> On request basis</p>
                 <p className="text-sm"><strong>Account:</strong> Debited to next year&apos;s account</p>
               </div>
             </div>
             ...
             <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-red-500">
               <div className="flex items-center mb-4">
                 ...
                 <h4 className="font-semibold text-gray-800">Journey Restrictions</h4>
               </div>
               <div className="space-y-2 text-gray-700">
                 <p className="text-sm"><strong>Timing:</strong> For journeys commencing in next year</p>
                 <p className="text-sm"><strong>Advance:</strong> Cannot be used for current year travel</p>
                 <p className="text-sm"><strong>Validity:</strong> Strict adherence to time limits</p>
               </div>
             </div>
           </div>
           ...
           <div className="space-y-6">
             <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-200">
               ...
               <div className="space-y-4 text-gray-700">
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>Year-ending passes have strict validity periods that cannot be extended</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>Advance issue is limited to FIVE months from date of issue</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>All advance issues are debited to the next year&apos;s account</p>
                 </div>
                 <div className="flex items-start">
                   <span className="text-yellow-500 mr-3 mt-1">•</span>
                   <p>Regular employees must exhaust current year passes before advance issue</p>
                 </div>
               </div>
             </div>
           ...
           <div className="mt-8 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-xl p-6 text-white">
             <div className="flex items-center justify-between">
               <div className="flex items-center">
                 ...
                 <div>
                   <h4 className="text-lg font-semibold">Year-ending Pass Assistance</h4>
                   <p className="text-teal-100">Contact your department for year-ending pass applications and advance issue queries</p>
                 </div>
               </div>
...
hands leading to fraudulent use for which the pass or PTO holder may have to share responsibility and be also liable for action under the rules. In case of loss
