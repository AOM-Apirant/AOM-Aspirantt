    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <section className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-xl shadow-xl p-8 mb-8 border-2 border-teal-200">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md border border-teal-200 mb-8">
            <p className="text-gray-700 leading-relaxed">
              Passes and PTOs are not transferable and should be used only by
              the person in whose favour they have been issued. Special care
              should be taken to ensure that passes and PTO&apos;s are not lost while
              in the custody of the pass holder. In the case of loss the pass or
              privilege ticket order may pass into unauthorised hands leading to
              fraudulent use for which the pass or PTO holder may have to share
              responsibility and be also liable for action under the rules. In
              case of loss of pass or PTO a report should be made immediately to
              the police by the pass or PTO holder sending a copy of the same to
              the Pass/Privilege Ticket Order issuing authority.
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-teal-200 mb-8">
            <p>
              2. Deterrent punishment should be awarded to railway servants
              detected misusing passes and privilege ticket orders; this may
              take the form of dismissal or removal from service or reduction to
              a lower post. 3. In case of a retired railway servant, misuse of
              post-retirement complimentary pass renders the retired railway
              servant liable to be declared ineligible for getting such passes.
              4. A fine of Rs. 10/- for second class and Rs.25/- for First Class
              passes may be imposed on the Railway employees for not filling the
              date of commencement of the journey on the passes both privilege
              and duty granted them. This amount has to be recovered from the
              employee by the ticket checking staff and the proper receipt
              issued. This fact may also be endorsed on the passes. Passes may
              also be returned within one month of the expiry of the pass or its
              utilization whichever is earlier. For non-filling the date of
              commencement of journey on the passes, the following action may be
              taken
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-md border border-teal-200 mb-8">
            <p>
              Note:- 1) Office bearer of recognised Unions/Federations who are
              either serving Rly. Employee or ex-Rly. employees will be treated
              at par with serving Rly. employees 2) Whenever it is proposed to
              award a penalty of stoppage of passes and Privilege Ticket Orders
              under RS(D&A) rules, as distinguished from action taken under the
              above rule for irregularities in connection with the use of passes
              and PTOs the procedures laid down in &quot;D&A Rules should be
              followed. 3) 3 times the cost to be recovered from serving
              officers who are on un authorised absence from duty and have not
              returned the metal pass despite request vide Board&apos;s Letter No.
