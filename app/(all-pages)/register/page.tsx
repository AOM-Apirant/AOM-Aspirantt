              ...
              <div className="w-full max-w-md space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">Comprehensive Study Materials</h4>
                      <p className="text-sm text-gray-600">Access all manuals, rules, and regulations</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">Track Your Progress</h4>
                      <p className="text-sm text-gray-600">Monitor your learning journey with analytics</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">Practice Quizzes</h4>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200 shadow-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">Updated Content</h4>
                      <p className="text-sm text-gray-600">Latest amendments and circular updates</p>
                    </div>
                  </div>
                </div>
              </div>
