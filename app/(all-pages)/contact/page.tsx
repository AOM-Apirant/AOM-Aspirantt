    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <div className="inline-flex items-center justify-center lg:w-20 lg:h-20 w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full mb-4 lg:mb-6">
            <MessageCircle className="lg:w-10 lg:h-10 w-6 h-6 text-white animate-pulse" />
          </div>
          <h1 className="lg:text-5xl text-2xl sm:text-3xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-4 lg:mb-6">
            Get In Touch
          </h1>
          <p className="lg:text-xl text-sm sm:text-base text-gray-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6 lg:space-y-8">
            <div>
              <h2 className="lg:text-3xl text-xl sm:text-2xl font-bold text-gray-900 lg:mb-8 mb-6">
                Contact Information
              </h2>
              <div className="space-y-4 lg:space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="group relative overflow-hidden bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div className="relative p-4 lg:p-6 flex items-center space-x-3 lg:space-x-4">
                      <div className="flex-shrink-0">
                        <div className={`lg:w-14 lg:h-14 w-10 h-10 bg-gradient-to-r ${info.gradient} rounded-lg flex items-center justify-center shadow-lg`}>
                          <info.icon className="lg:w-7 lg:h-7 w-4 h-4 text-white" />
                        </div>
                      </div>
                      <div className="flex-1">
                        <h3 className="lg:text-xl text-base sm:text-lg font-semibold text-gray-900 mb-1 lg:mb-2">
                          {info.title}
                        </h3>
                        {info.link ? (
                          <a
                            href={info.link}
                            className="lg:text-lg text-sm sm:text-base text-blue-600 hover:text-blue-800 transition-colors font-medium"
                          ...
                          <p className="lg:text-lg text-sm sm:text-base text-gray-700 font-medium">{info.details}</p>
                        )}
                      </div>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 lg:p-8 border border-gray-100 relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="lg:text-3xl text-xl sm:text-2xl font-bold text-gray-900 mb-6 lg:mb-8">
                Send Us a Message
              </h2>
              ...
              {isSubmitted ? (
                <div className="text-center py-8 lg:py-12">
                  ...
                  <h3 className="lg:text-2xl text-xl font-bold text-gray-900 mb-2 lg:mb-3">
                    Thank You!
                  </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
                  {error && (
                    <div className="p-3 lg:p-4 bg-red-50 border border-red-200 rounded-lg flex items-center space-x-3">
                      <AlertCircle className="w-4 h-4 lg:w-5 lg:h-5 text-red-500 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full px-3 lg:px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 resize-none text-sm lg:text-base"
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white py-2.5 lg:py-3 px-6 lg:px-8 rounded-lg font-semibold text-base lg:text-lg hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 focus:ring-4 focus:ring-blue-100 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 lg:space-x-3 transform hover:scale-105"
                  >
                    {isSubmitting ? (
                      <>
        ...
        <div className="mt-12 lg:mt-16">
          <div className="bg-white rounded-3xl shadow-2xl p-6 lg:p-8 border border-gray-100 relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="lg:text-3xl text-xl sm:text-2xl font-bold text-gray-900 mb-6 lg:mb-8 text-center">
                Our Location
              </h2>
              <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  <div className="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 lg:mb-6 shadow-lg">
                    <MapPin className="w-6 h-6 lg:w-8 lg:h-8 text-white animate-pulse" />
                  </div>
                  <p className="lg:text-xl text-base sm:text-lg text-gray-700 font-semibold mb-1 lg:mb-2">
                    Hyderabad, Telangana, India
                  </p>
                  <p className="lg:text-lg text-sm sm:text-base text-gray-500">
