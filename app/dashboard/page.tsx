    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600">Loading your dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-6 sm:py-8 md:py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12 animate-fade-in-up">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="p-2 bg-white/60 backdrop-blur-sm rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 border border-white/20 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        {/* Stats Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8 md:mb-12">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 sm:p-6 border border-gray-300 animate-slide-in-left">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 sm:p-6 border border-gray-300 animate-slide-in-left" style={{animationDelay: '0.1s'}}>
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 sm:p-6 border border-gray-300 animate-slide-in-right" style={{animationDelay: '0.1s'}}>
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 sm:p-6 border border-gray-300 animate-slide-in-right">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Quick Actions */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8 md:mb-12">
          <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-4 sm:p-6 md:p-8 border border-gray-300 animate-fade-in-up">
            ...
            <div className="space-y-3 sm:space-y-4">
              <Link
                href="/quiz"
                className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl hover:from-blue-100 hover:to-purple-100 transition-all duration-200"
              >
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 text-sm sm:text-base">Start New Quiz</h3>
                    <p className="text-gray-600 text-xs sm:text-sm">Challenge yourself with new questions</p>
                  </div>
                </div>
              ...
              <Link
                href="/about"
                className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl hover:from-green-100 hover:to-blue-100 transition-all duration-200"
              >
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 text-sm sm:text-base">Learn More</h3>
                    <p className="text-gray-600 text-xs sm:text-sm">Discover our platform features</p>
                  </div>
                </div>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        {/* Motivation Section */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 text-white animate-fade-in-up">
          <div className="text-center">
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Keep Learning!</h2>
