export const abbreviations = {
    A: [
      { acronym: 'AAWS', fullForm: 'Advanced Approach Warning System' },
      ...
      { acronym: 'AFRES', fullForm: 'Advanced Finance & Railway Earning & Expenditure System' },
    ...
    B: [
      ...
      { acronym: 'BCXT', fullForm: 'Bogie Wagon Covered with Transitional Coupling' },
      { acronym: 'BCN', fullForm: 'Bogie Wagon Covered with Air Brake & CTC' },
      { acronym: 'BCNA', fullForm: 'Bogie Wagon Covered Arrangement for Improved' },
      ...
      { acronym: 'BOXNHS', fullForm: 'Bogie Open with Air Brake High Speed (CBC)' },
      { acronym: 'BOXNHSM1', fullForm: 'Bogie Open with Air Brake High Speed Modified 1' },
      ...
      { acronym: 'BOXMN1', fullForm: 'Bogie Open Air Brake Light Weight Modified 1' },
      ...
      { acronym: 'BVGC', fullForm: 'Brake Van Goods with CBC Coupling 4 Wheeler (Air Brake)' },
    ...
    C: [
      ...
      { acronym: 'CAMTECH', fullForm: 'Centre for Advanced Maintenance Technology.' },
      ...
      { acronym: 'CBTC', fullForm: 'Communication based train control technology' },
      ...
      { acronym: 'CGEGIS', fullForm: 'Central Government Employee Group Insurance Scheme' },
      ...
      { acronym: 'CORE', fullForm: 'Central Organization for Railway Electrification' },
      { acronym: 'COTVM', fullForm: 'Currency Operated Ticket Vending Machine' },
      { acronym: 'CPGO', fullForm: 'Chief Public Grievance Officer' },
      { acronym: 'CPGRAMS', fullForm: 'Centralized Public Grievance Redress And Monitoring System' },
    ...
    D: [
      ...
      { acronym: 'DFCCIL', fullForm: 'Dedicated Freight Corridor Corporation of India Limited' },
      ...
      { acronym: 'DRUCC', fullForm: 'Divisional Railway Users Consultative Committee' },
      ...
      { acronym: 'DSTE', fullForm: 'Divisional Signal & Telecommunication Engineer' },
    ...
    E: [
      ...
      { acronym: 'ESS', fullForm: 'Employee Self Service & Internal Applications' },
    ...
    H: [
      ...
      { acronym: 'HOER', fullForm: 'Hours Of Employment Regulation (Hours of Work & Period of Rest Rules)' },
    ...
    I: [
      ...
      { acronym: 'IRCTC', fullForm: 'Indian Railway Categoring & Tourism Corporation Limited' },
    ...
    K: [
      { acronym: 'KRCL', fullForm: 'Konkan Railway Corporation Limited' },
    ],
    L: [
    ...
    P: [
      ...
      { acronym: 'PCSTE', fullForm: 'Principal Chief Signal and Telecommunication Engineer' },
    ...
    S: [
      { acronym: 'SAMPRATI', fullForm: 'Status Alerts in Monitoring Projects Related Actions & Targets Importance' },
      { acronym: 'SATSANG', fullForm: 'Software Aided Train Scheduling And Network Governance' },
      ...
      { acronym: 'SMARTS', fullForm: 'Singular Modular Advance Railway Ticketing System' },
      { acronym: 'SMOCIP', fullForm: 'Station Master Operation Cum Identification Panel' },
      ...
      { acronym: 'SPARME', fullForm: 'Self Profelled Accident Relief Medical Equipment' },
      { acronym: 'SPARROW', fullForm: 'Smart Performance Appraisal Report Recording Online Window' },
      { acronym: 'SPART', fullForm: 'Self Profelled Accident Relief Trains' },
      { acronym: 'SPASHT', fullForm: 'Safe Practices Avoiding Shortcut Methods in Train Operations' },
      { acronym: 'SPT', fullForm: 'Signal Post Telephone' },
      { acronym: 'SPTM', fullForm: 'Self Printing Ticket Machines' },
      { acronym: 'SPURT', fullForm: 'Self Profelled Ultrasonic Rail Testing Car' },
      { acronym: 'SSBPAC', fullForm: 'Solid State Block Proving by Axle Counter' },
    ...
    T: [
      { acronym: 'TACLS', fullForm: 'Train Actuated Control Level Crossing System' },
    ...
    W: [
      ...
      { acronym: 'WGSCZ', fullForm: 'Vestibule Self-Generated Second Class Chair Car' },
      { acronym: 'WGSCZAC', fullForm: 'Vestibule Self-Generated Second Class AC Chair Car' },
      ...
      { acronym: 'WGSCNLR', fullForm: 'Vestibule Self-Generated Second Class Three Tier Sleeper Luggage' },
