...
(c) Main line clear after backing into siding`,
  },
  {
    id: 4,
    code: "0 0 0",
    description: `(a) Guard to apply brakes.
(b) Train is out of control, Guard to assist.`,
  },
  {
    id: 5,
    code: "0 0 0 0",
    description: `(a) Train cannot proceed on account of accident, failure, obstruction or
...
(b) Protect train in rear.`,
  },
  {
    id: 6,
    code: "– – 0 0",
    description: `Call for Guard to come to engine.`,
  },
  {
    id: 7,
    code: "0 – 0",
    description: `(a) Token not received.
(b) Token missed.
...
(d) Passing Stop signal at ‘on’ with proper authority.`,
  },
  {
    id: 8,
    code: "–",
    description: `(a) Before starting, vacuum/air pressure recreated on ghat section,
remove sprags.
