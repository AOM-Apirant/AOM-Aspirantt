    ...
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-orange-900 to-yellow-900 relative overflow-hidden">
      ...
      <div className="relative z-10 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Footer Message */}
          <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl shadow-2xl p-8 text-center border border-green-400/30 backdrop-blur-lg hover:shadow-3xl transition-all duration-300">
