      ...
      <div className="relative z-10 py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white py-6 px-8 rounded-2xl shadow-2xl mb-8 border border-red-400/30 backdrop-blur-lg">
              <div className="flex items-center justify-center mb-4">
                ...
                <h1 className="text-4xl md:text-5xl font-bold animate-fade-in">🚨 Accident Relief Equipment</h1>
              </div>
              <p className="text-xl md:text-2xl font-semibold text-red-100">Status of 140T BD Cranes, ARTs, ARMVs & RARVs over SCR</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
              <h2 className="text-2xl md:text-3xl font-bold text-red-300 mb-6 flex items-center justify-center">
              ...
              <p className="text-lg md:text-xl text-gray-200 mb-6 leading-relaxed">
                Comprehensive network of <span className="font-bold text-red-400 bg-red-900/30 px-2 py-1 rounded">Accident Relief Trains (ARTs)</span> and
                <span className="font-bold text-red-400 bg-red-900/30 px-2 py-1 rounded"> specialized vehicles</span> across South Central Railway
              </p>
              
              <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-l-4 border-yellow-400 p-6 rounded-xl backdrop-blur-sm border border-yellow-400/30">
                <h3 className="text-xl md:text-2xl font-bold text-yellow-300 mb-3 flex items-center">
          ...
          {/* ART Locations Grid */}
          <div className="mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    <div className="bg-blue-500/10 backdrop-blur-sm p-6 rounded-xl border border-blue-400/30">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          ...
                          <span className="bg-blue-500/20 text-blue-300 px-4 py-2 rounded-lg font-bold border border-blue-400/30 backdrop-blur-sm">&quot;A&quot; Class</span>
                        </div>
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                    ...
                    <div className="bg-green-500/10 backdrop-blur-sm p-6 rounded-xl border border-green-400/30">
                      ...
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                        <span className="font-medium text-gray-200">Type:</span>
                        <span className="bg-green-500/20 text-green-300 px-4 py-2 rounded-lg font-bold border border-green-400/30 backdrop-blur-sm">&quot;B&quot; Class (SPART)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-green-500/10 backdrop-blur-sm p-6 rounded-xl border border-green-400/30">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Type:</span>
                          <span className="bg-green-500/20 text-green-300 px-4 py-2 rounded-lg font-bold border border-green-400/30 backdrop-blur-sm">&quot;A&quot; Class</span>
                        </div>
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Crane:</span>
                    ...
                    <div className="bg-blue-500/10 backdrop-blur-sm p-6 rounded-xl border border-blue-400/30">
                      ...
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                        <span className="font-medium text-gray-200">Type:</span>
                        <span className="bg-blue-500/20 text-blue-300 px-4 py-2 rounded-lg font-bold border border-blue-400/30 backdrop-blur-sm">&quot;B&quot; Class (SPART)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-purple-500/10 backdrop-blur-sm p-6 rounded-xl border border-purple-400/30">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Type:</span>
                          <span className="bg-purple-500/20 text-purple-300 px-4 py-2 rounded-lg font-bold border border-purple-400/30 backdrop-blur-sm">&quot;A&quot; Class</span>
                        </div>
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Crane:</span>
                          <span className="text-sm text-gray-300">Cowans Sheldon Old Design-140T</span>
                    ...
                    <div className="bg-orange-500/10 backdrop-blur-sm p-6 rounded-xl border border-orange-400/30">
                      ...
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                        <span className="font-medium text-gray-200">Type:</span>
                        <span className="bg-orange-500/20 text-orange-300 px-4 py-2 rounded-lg font-bold border border-orange-400/30 backdrop-blur-sm">&quot;B&quot; Class (SPART)</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20 hover:bg-white/15 transition-all duration-300 group">
                <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white py-6 px-6">
                  <h4 className="text-xl md:text-2xl font-bold flex items-center">
                    <span className="bg-white/20 rounded-full p-2 mr-3 backdrop-blur-sm group-hover:bg-white/30 transition-all">
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                      ...
                      <span className="bg-orange-500/20 text-orange-300 px-4 py-2 rounded-lg font-bold border border-orange-400/30 backdrop-blur-sm">&quot;B&quot; Class</span>
                    </div>
                    <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20 hover:bg-white/15 transition-all duration-300 group">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    <div className="bg-indigo-500/10 backdrop-blur-sm p-6 rounded-xl border border-indigo-400/30">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Type:</span>
                          <span className="bg-indigo-500/20 text-indigo-300 px-4 py-2 rounded-lg font-bold border border-indigo-400/30 backdrop-blur-sm">&quot;A&quot; Class</span>
                        </div>
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Crane:</span>
                          <span className="text-sm text-gray-300">Cowans Sheldon Old Design-140T</span>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                        ...
                        <span className="bg-indigo-500/20 text-indigo-300 px-4 py-2 rounded-lg font-bold border border-indigo-400/30 backdrop-blur-sm">&quot;B&quot; Class</span>
                      </div>
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20 hover:bg-white/15 transition-all duration-300 group">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    <div className="bg-red-500/10 backdrop-blur-sm p-6 rounded-xl border border-red-400/30">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Type:</span>
                          <span className="bg-red-500/20 text-red-300 px-4 py-2 rounded-lg font-bold border border-red-400/30 backdrop-blur-sm">&quot;A&quot; Class</span>
                        </div>
                        <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                          <span className="font-medium text-gray-200">Crane:</span>
                    ...
                    <div className="bg-green-500/10 backdrop-blur-sm p-6 rounded-xl border border-green-400/30">
                      ...
                      <div className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
                        <span className="font-medium text-gray-200">Type:</span>
                        <span className="bg-green-500/20 text-green-300 px-4 py-2 rounded-lg font-bold border border-green-400/30 backdrop-blur-sm">&quot;B&quot; Class</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center flex items-center justify-center">
              ...
              🏗️ 140-T DHBD Cranes Specifications
            </h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-blue-500/10 to-indigo-500/10 backdrop-blur-sm rounded-xl p-6 border border-blue-400/30 hover:bg-blue-500/20 transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                      <span className="font-medium text-gray-200">Type:</span>
                      <span className="font-bold text-blue-300">{crane.type}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                      <span className="font-medium text-gray-200">Capacity:</span>
                      <span className="font-bold text-green-300">{crane.capacity}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                    ...
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                      ...
                      <span className={`font-bold ${crane.design === 'New' ? 'text-green-300' : 'text-orange-300'}`}>
                        {crane.design}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                    ...
                    <div className="flex justify-between items-center py-2 px-3 bg-white/5 rounded-lg">
                      ...
                      <span className="font-bold text-purple-300">{crane.speed}</span>
                    </div>
                  </div>
                </div>
              ))}
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300 border-b border-gray-700/30 last:border-b-0">
                      ...
                      <span className={`px-4 py-2 rounded-lg text-sm font-bold backdrop-blur-sm border ${
                  ...
                  {[
                    ...
                    <div key={index} className="flex justify-between items-center py-3 px-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300 border-b border-gray-700/30 last:border-b-0">
                      <div className="flex items-center">
                        <span className="w-8 h-8 bg-purple-500/20 text-purple-300 rounded-full flex items-center justify-center text-sm font-bold mr-3 border border-purple-400/30 backdrop-blur-sm">
                          {index + 1}
                        </span>
                        <div>
                      ...
                      <span className="bg-purple-500/20 text-purple-300 px-4 py-2 rounded-lg text-sm font-bold border border-purple-400/30 backdrop-blur-sm">
                        RARV
                      </span>
                    </div>
                  ))}
          ...
          {/* Footer Message */}
          <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-2xl shadow-2xl p-8 text-center border border-red-400/30 backdrop-blur-lg hover:shadow-3xl transition-all duration-300">
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold">🆘 Emergency Response Network</h3>
            </div>
