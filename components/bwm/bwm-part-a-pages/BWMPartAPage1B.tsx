                    ...
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                      <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                          ...
                          {/* Plunger */}
                          <div className="group hover:bg-white/5 p-4 rounded-lg transition-all duration-300">
                            <h4 className="text-xl font-semibold text-pink-300 mb-3 flex items-center gap-2">
                          ...
                          <div className="group hover:bg-white/5 p-4 rounded-lg transition-all duration-300">
                            <h4 className="text-xl font-semibold text-lime-300 mb-3 flex items-center gap-2">
