          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  ...
                  <div className="flex-1">
                    <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/20">
                      <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                        T.806 alone shall be given where shunt key is not available. Shunt key, where available, shall be given in addition to T.806.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="group hover:bg-white/5 py-3 lg:px-4 px-2 lg:py-6 rounded-xl transition-all duration-300 border border-white/10 hover:border-white/20 mt-6">
              <div className="flex flex-col gap-3 items-center space-y-4 relative">
                <div className="flex-shrink-0">
                  <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                    <span className="text-white font-bold lg:text-lg text-base">3.4.1</span>
                  </div>
                </div>
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                    Shunting Between the Last Stop Signal and Opposing First Stop Signal<br />
                  ...
                  <div className="bg-gradient-to-r from-pink-500/10 to-purple-500/10 p-4 rounded-xl border border-pink-400/20 mt-6">
                    <h4 className="text-2xl font-bold text-pink-300 mb-3 flex flex-col gap-2 items-center justify-center text-center">
                      3.4.2. Shunting Beyond the First Stop Signal on Single Line <br />
