...
const BWMPartAPage30A: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-2">BWMS(T)- PART-A 30</h2>
            <h3 className="lg:text-3xl text-xl font-bold text-blue-300 mb-4">USE OF SPECIAL SIGNALS AND PROCEDURE IN EMERGENCIES</h3>
...
export default BWMPartAPage30A