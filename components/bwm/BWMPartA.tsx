  ...
  const chapters = [
    {
      ...
      rules: [
        { number: "1.1", title: "Provision of Token Block Instruments", page: "1" },
        { number: "1.2", title: "Description of Neale's Ball Token Instrument", page: "1" },
        { number: "1.3", title: "Description of Neale's Tablet Token Instrument", page: "3" },
        { number: "1.4", title: "Indoor Apparatus", page: "4" },
        { number: "1.5", title: "Outdoor Apparatus", page: "4" }
      ]
    },
    {
      id: 2,
      ...
      rules: [
        { number: "2.1", title: "Systems of working", page: "5" },
        { number: "2.2", title: "Block Competency Certificate", page: "5" },
        { number: "2.3", title: "Bell Code", page: "6" },
        { number: "2.4", title: "Precedence of trains", page: "7" },
        { number: "2.5", title: "Acknowledgement of Signals", page: "8" },
        { number: "2.6", title: "Train Signal Register", page: "8" },
        { number: "2.7", title: "Inspection of Train Signal Register", page: "10" },
        { number: "2.8", title: "Preservation of Train Signal Register", page: "11" },
        { number: "2.9", title: "Station Masters handing over / taking over charge", page: "11" }
      ]
    },
    {
      id: 3,
      ...
      rules: [
        { number: "3.1", title: "Access to and operation of equipment", page: "13" },
        { number: "3.2", title: "Signalling of a train from one block station to another block station", page: "13" },
        { number: "3.3(A)", title: "To cancel Line Clear before train enters into Block Section (G.R. 14.22)", page: "15" },
        { number: "3.3(B)", title: "Closing of Block Section after pushing back of train", page: "16" },
        ...
        { number: "3.7", title: "The 'Call attention' signal", page: "21" },
        { number: "3.8", title: "The 'Is line clear' signal – when to be sent", page: "21" },
        { number: "3.9", title: "Precautions before asking 'Line clear'", page: "21" },
        { number: "3.10", title: "'Is line clear' - when to be asked", page: "22" },
        { number: "3.11", title: "Acceptance of the 'Is line clear' signal and sending of 'Line clear' signal", page: "22" },
        { number: "3.12", title: "Precautions before giving 'line clear'", page: "22" },
        { number: "3.13", title: "Giving 'Line Clear'", page: "23" },
        { number: "3.14", title: "Securing of token for delivery", page: "23" },
        { number: "3.15", title: "Authority to proceed", page: "23" },
        { number: "3.16", title: "Delivery of token (Authority to proceed) to the Driver", page: "24" },
        { number: "3.17", title: "'Train entering block section' signal", page: "26" },
        { number: "3.18", title: "Surrendering of token by Driver at station", page: "26" },
        { number: "3.19", title: "Insertion of token in the block instrument", page: "26" },
        { number: "3.20", title: "Giving the 'Train out of block section' or 'Obstruction removed' signal", page: "27" },
        { number: "3.21", title: "Token neither to be transferred from one train to another nor wrong token to be handed over", page: "27" },
        { number: "3.22", title: "Private Numbers", page: "28" }
      ]
    },
    {
      id: 4,
    ...
    },
    {
      ...
      rules: [
        { number: "5.1", title: "Refusal of the 'Is line clear' signal, and sending of the 'Obstruction danger' signal", page: "30" },
        { number: "5.2", title: "Special use of 'Obstruction danger' signal", page: "30" },
        { number: "5.3", title: "'Cancel last signal'", page: "30" },
        { number: "5.4", title: "'Signal given in error' signal", page: "31" },
        { number: "5.5", title: "Trains unusually delayed", page: "31" },
        { number: "5.6", title: "'Stop and examine train' signal", page: "32" },
        { number: "5.7", title: "'Train passed without tail lamp / flashing tail lamp or tail board' signal", page: "33" },
        { number: "5.8", title: "'Train divided' signal", page: "33" },
    ...
    },
    {
      ...
      rules: [
        { number: "7.1", title: "The 'Testing' signal", page: "38" },
        { number: "7.2", title: "Persons authorized to Test", page: "38" },
        { number: "7.3", title: "Block Section to be clear during Test", page: "38" },
        { number: "7.4", title: "Procedure for Testing", page: "38" },
        { number: "7.5", title: "Removal of defective Tokens or provision of New Token", page: "39" },
        { number: "7.6", title: "Replacement of token instruments", page: "40" },
        { number: "7.7", title: "Balancing of tokens in token instruments", page: "40" },
        ...
        { number: "7.9", title: "Consent required before interfering with block working equipment", page: "42" },
        { number: "7.10", title: "Block instruments maintenance work by S & T staff", page: "42" }
      ]
    },
    {
      id: 8,
      ...
      rules: [
        ...
        { number: "8.3", title: "Block instruments failure record", page: "47" },
        { number: "8.4", title: "Reports to be sent", page: "47" },
        ...
        { number: "8.10", title: "Resumption of block working after interruption or suspension", page: "55" },
        { number: "8.11", title: "Total interruption of communications on single line", page: "55" }
      ]
    }
  ]
