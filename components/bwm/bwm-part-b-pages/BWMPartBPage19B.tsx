                    ...
                    <div className="space-y-6">
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          <span className="font-bold text-blue-300">a)</span> On controlled sections, trains shall be worked strictly in accordance with the orders of the Controller.
                        </p>
                      </div>

                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-300 font-bold lg:text-lg text-base mb-4">b) On non-controlled sections or in the event of breakdown of control, the trains shall be given precedence over each other in the following order:</h4>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          <span className="font-bold text-blue-300">c)</span> Owing to the irregular running of trains, if two or more trains are ready to start from the same end of a block section, preference shall be given to the trains standing higher in the table of precedence. If both trains have the same order of precedence, preference shall be given to the one having the greater distance to run.
                        </p>
                      </div>

                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-300 font-bold lg:text-lg text-base mb-4">d) In order to avoid excessive detention to trains of lesser importance:</h4>
                        <div className="space-y-3">
                          <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                            <span className="font-bold text-blue-300">i)</span> A Mail or Express train running less than ten minutes late may be detained up to a total of ten minutes in order to save a delay of thirty minutes or more to a passenger train or forty five minutes to a goods train.
                          </p>
                          <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                            <span className="font-bold text-blue-300">ii)</span> A passenger train running less than ten minutes late may be detained up to a total of ten minutes in order to avoid a delay of thirty minutes or more to a goods train.
                          </p>
                        </div>
                      </div>
                    </div>
