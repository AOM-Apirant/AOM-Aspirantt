...
const BWMPartBPage61B: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Tail Lamp / Tail Board Missing Procedures</h2>
...
export default BWMPartBPage61B