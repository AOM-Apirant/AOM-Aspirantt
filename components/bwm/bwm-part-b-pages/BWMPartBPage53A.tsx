                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed mb-4">
                          At intermediate stations, for all stopping trains, which halt for less than five minutes, the <span className="text-blue-300 font-semibold">&apos;Line clear&apos;</span> in case of Handle type block instruments and the <span className="text-blue-300 font-semibold">TGT</span> indication in case of Push button block instruments shall be obtained <span className="text-green-300 font-semibold">when the train is sighted</span>; and for all the trains booked to run through the station, it shall be obtained <span className="text-yellow-300 font-semibold">seven minutes before</span> the train is due to pass through, calculating from the time the <span className="text-blue-300 font-semibold">&apos;Line clear&apos;</span>/<span className="text-blue-300 font-semibold">TOL</span> indication is obtained or immediately after getting the <span className="text-blue-300 font-semibold">&apos;Line clear&apos;</span>/<span className="text-blue-300 font-semibold">TOL</span> indication , in case the running time is less than seven minutes.
                        </p>
                      </div>
                    </div>
