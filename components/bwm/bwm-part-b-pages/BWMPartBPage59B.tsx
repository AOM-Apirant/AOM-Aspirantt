...
const BWMPartBPage59B: React.FC = () => {
  return (
      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-3xl text-xl font-bold text-indigo-300 mb-4">Line Clear Cancellation Procedures</h2>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-yellow-500/10 border border-yellow-400/30 rounded-lg p-4">
                        <p className="text-yellow-200 lg:text-base text-sm leading-relaxed">
                          <span className="font-bold text-yellow-300">Note:</span> After cancelling the <span className="text-blue-300 font-semibold">&apos;Line clear&apos;</span> as described above, the Station Master shall enter the reasons for doing so in the Train Signal Register.
                        </p>
                      </div>
                    </div>
...
export default BWMPartBPage59B