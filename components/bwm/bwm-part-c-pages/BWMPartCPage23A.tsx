                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                          <span className="text-yellow-300 font-semibold">a)</span> The <span className="text-green-300 font-semibold">&apos;Call attention&apos;</span> signal shall be given when it is necessary to direct the attention to the <span className="text-green-300 font-semibold">block instruments</span>.
                        </p>
                      </div>
