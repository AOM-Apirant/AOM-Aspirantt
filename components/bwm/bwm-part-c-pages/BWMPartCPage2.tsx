                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">a)</span> The &apos;Train Going To dial&apos;:
                        </h4>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">(b)</span> The &apos; Train Coming From dial&apos;:
                        </h4>
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">(c)</span> The Operating Handle:
                        </h4>
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">(d)</span> Bell plunger:
                        </h4>
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">(e)</span> Bell:
                        </h4>
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      ...
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <h4 className="text-blue-200 font-bold lg:text-xl text-lg mb-3">
                          <span className="text-yellow-300">(f)</span> Telephone:
                        </h4>
                        <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
