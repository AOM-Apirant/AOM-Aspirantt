                    ...
                    <div className="space-y-4">
                      <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <div className="space-y-2 ml-4">
                          <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                            <span className="text-yellow-300 font-semibold">A)</span> <span className="text-blue-300 font-semibold">S.G.E. type Lock and Block instrument;</span>
                          </p>
                          <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                            <span className="text-yellow-300 font-semibold">B)</span> <span className="text-blue-300 font-semibold">SSBPAC(D) – Double Line Block instrument</span> and
                          </p>
                          <p className="text-gray-200 lg:text-lg text-base leading-relaxed">
                            <span className="text-yellow-300 font-semibold">C)</span> <span className="text-blue-300 font-semibold">UFSBI - Double Line Block instrument.</span>
                          </p>
                        </div>
                      </div>
