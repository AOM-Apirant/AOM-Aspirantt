        ...
        <div className="space-y-6 text-gray-800 leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg p-4 shadow-md">
              <h3 className="font-semibold text-teal-700 mb-2">1. Alternative Routes Available</h3>
              <p>
            ...
            <div className="bg-white rounded-lg p-4 shadow-md">
              <h3 className="font-semibold text-teal-700 mb-2">2. Longer Route Within 15% Distance</h3>
              <p>
            ...
            <div className="bg-white rounded-lg p-4 shadow-md">
              <h3 className="font-semibold text-teal-700 mb-2">3. Quicker Route Option</h3>
              <p>
