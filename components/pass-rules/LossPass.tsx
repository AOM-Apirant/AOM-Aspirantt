        ...
        <div className="space-y-4 sm:space-y-6 text-gray-800 leading-relaxed">
          ...
          <div className="bg-yellow-50 rounded-lg p-3 sm:p-4 border-l-4 border-yellow-400">
            ...
            <ol className="list-decimal list-inside space-y-1 sm:space-y-2 text-xs sm:text-sm">
              ...
              employees</li>
              <li>Whenever it is proposed to award a penalty of stoppage of passes and Privilege
              ...
              the procedures laid down in &quot;D&A Rules&quot; should be followed.</li>
              <li>3 times the cost to be recovered from serving officers who are on un
