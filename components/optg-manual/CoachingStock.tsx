        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl lg:py-10 py-8 lg:px-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <h2 className="lg:text-3xl text-2xl font-bold text-white mb-8 flex lg:flex-row flex-col gap-4 items-center justify-center">
              <span className="bg-gradient-to-r from-violet-500 to-purple-500 lg:p-4 p-3 rounded-full mr-4 shadow-lg">
                <svg className="lg:w-8 lg:h-8 w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-violet-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl lg:p-8 p-4 shadow-lg border border-violet-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-1">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl lg:p-6 p-3 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <h3 className="lg:text-xl text-base font-bold text-white mb-4 flex lg:flex-row flex-col gap-4 items-center text-center">
                    <span className="text-violet-400 mr-3 lg:text-2xl text-xl">🚂</span>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl lg:py-10 py-8 lg:px-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-xl text-base font-bold text-white mb-4 text-center lg:text-left">Basic Facilities</h3>
                <div className="space-y-3">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-purple-400 mr-3 lg:text-lg text-base font-bold">W</span>
                    <span className="text-white lg:text-sm text-xs">Vestibuled</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-purple-400 mr-3 lg:text-lg text-base font-bold">G</span>
                    <span className="text-white lg:text-sm text-xs">Self-Generating</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-purple-400 mr-3 lg:text-lg text-base font-bold">S</span>
                    <span className="text-white lg:text-sm text-xs">Second Class</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-purple-400 mr-3 lg:text-lg text-base font-bold">F</span>
                    <span className="text-white lg:text-sm text-xs">First Class</span>
                  </div>
                </div>
              </div>

              {/* Specialized Coaches */}
              <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-xl text-base font-bold text-white mb-4 text-center lg:text-left">Specialized Coaches</h3>
                <div className="space-y-3">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 lg:text-lg text-base font-bold">L</span>
                    <span className="text-white lg:text-sm text-xs">Luggage Van</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 lg:text-lg text-base font-bold">R</span>
                    <span className="text-white lg:text-sm text-xs">Guard Brake Van</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 lg:text-lg text-base font-bold">Y</span>
                    <span className="text-white lg:text-sm text-xs">Ladies Compartment</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 lg:text-lg text-base font-bold">J</span>
                    <span className="text-white lg:text-sm text-xs">Ice Compartment</span>
                  </div>
                </div>
              </div>

              {/* AC and Sleeper Classes */}
              <div className="bg-gradient-to-br from-rose-500/20 to-red-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-rose-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-xl text-base font-bold text-white mb-4 text-center lg:text-left">AC & Sleeper Classes</h3>
                <div className="space-y-3">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 lg:text-lg text-base font-bold">AC</span>
                    <span className="text-white lg:text-sm text-xs">Air Conditioned</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 lg:text-lg text-base font-bold">CN</span>
                    <span className="text-white lg:text-sm text-xs">Sleeper Class Three Tier</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 lg:text-lg text-base font-bold">CW</span>
                    <span className="text-white lg:text-sm text-xs">Sleeper Class Two Tier</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-3 p-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 lg:text-lg text-base font-bold">CZ</span>
                    <span className="text-white lg:text-sm text-xs">Chair Car</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl lg:py-10 py-8 lg:px-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl lg:p-8 p-4 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h3 className="lg:text-xl text-base font-bold text-white mb-2">First Two Digits</h3>
                  <p className="text-gray-200 text-sm mb-2">
                    Indicate the year of manufacture of the stock.
                  </p>
                </div>
                <div>
                  <h3 className="lg:text-xl text-base font-bold text-white mb-2">Third Digit</h3>
                  <p className="text-gray-200 text-sm mb-2">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                <div className="flex lg:flex-row flex-col gap-4 items-center bg-white/10 backdrop-blur-sm rounded-lg p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <span className="text-red-400 mr-3 text-xl font-bold">0</span>
                  <span className="text-white lg:text-sm text-xs">FAC & ACCW (First AC or 2-tier AC)</span>
                </div>
                <div className="flex lg:flex-row flex-col gap-4 items-center bg-white/10 backdrop-blur-sm rounded-lg p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl lg:py-10 py-8 lg:px-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <h2 className="lg:text-3xl text-2xl font-bold text-white mb-8 flex lg:flex-row flex-col gap-4 items-center justify-center text-center">
              <span className="bg-gradient-to-r from-orange-500 to-yellow-500 lg:p-4 p-3 rounded-full mr-4 shadow-lg">
                <svg className="lg:w-8 lg:h-8 w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-3xl text-xl font-bold text-white mb-4 flex lg:flex-row flex-col gap-4 items-center text-center">
              ...
              <div className="bg-gradient-to-br from-yellow-500/20 to-amber-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-yellow-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-3xl text-xl font-bold text-white mb-4 flex lg:flex-row flex-col gap-4 items-center text-center">
              ...
              {/* IOH Maintenance */}
              <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-amber-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-3xl text-xl font-bold text-white mb-4 flex lg:flex-row flex-col gap-4 items-center text-center">
              ...
              {/* POH Maintenance */}
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-3 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="lg:text-3xl text-xl font-bold text-white mb-4 flex lg:flex-row flex-col gap-4 items-center text-center">
                  <span className="text-orange-400 mr-3 text-2xl">🏭</span>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl lg:py-10 py-8 lg:px-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1">
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                ...
                <span className="text-gray-200 lg:text-lg text-base">Systematic coach classification</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔢</span>
                <span className="text-gray-200 lg:text-lg text-base">Unique five-digit numbering</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔧</span>
              ...
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📊</span>
                <span className="text-gray-200 lg:text-lg text-base">Efficient rake link management</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">👥</span>
                <span className="text-gray-200 lg:text-lg text-base">Optimized crew scheduling</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-1 transition-all duration-300">
                <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📋</span>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl lg:p-8 p-4 shadow-xl border border-white/20">
            <h3 className="lg:text-2xl text-xl font-bold text-white mb-8 flex lg:flex-row flex-col gap-4 items-center justify-center text-center">
              <span className="lg:w-4 lg:h-4 w-3 h-3 bg-gradient-to-br from-violet-500 to-purple-500 rounded-full mr-3 animate-pulse"></span>
              Summary
            </h3>
            <div className="bg-gradient-to-br from-violet-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl lg:p-8 p-4 shadow-lg border border-violet-400/30">
