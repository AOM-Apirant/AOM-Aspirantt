    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-900 via-cyan-900 to-blue-900 relative overflow-hidden">
      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-teal-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  ...
                  <span className="text-white font-semibold text-lg">Coaching</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <span className="text-teal-400 mr-3 text-xl">📦</span>
                  <span className="text-white font-semibold text-lg">Freight</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <span className="text-teal-400 mr-3 text-xl">🔗</span>
                  <span className="text-white font-semibold text-lg">Mixed</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-cyan-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-cyan-400 mr-3 text-xl font-bold">W</span>
                    <span className="text-white font-semibold text-lg">Broad gauge</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-cyan-400 mr-3 text-xl font-bold">Y</span>
                    <span className="text-white font-semibold text-lg">Meter gauge</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-cyan-400 mr-3 text-xl font-bold">Z</span>
                    <span className="text-white font-semibold text-lg">Narrow gauge (2ft6in)</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-cyan-400 mr-3 text-xl font-bold">N</span>
                    <span className="text-white font-semibold text-lg">Narrow gauge (2ft)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-blue-400 mr-3 text-xl font-bold">D</span>
                    <span className="text-white font-semibold text-lg">Diesel</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-blue-400 mr-3 text-xl font-bold">C</span>
                    <span className="text-white font-semibold text-lg">DC electric</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-blue-400 mr-3 text-xl font-bold">A</span>
                    <span className="text-white font-semibold text-lg">AC</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-blue-400 mr-3 text-xl font-bold">CA</span>
                    <span className="text-white font-semibold text-lg">Both DC & AC</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-blue-400 mr-3 text-xl font-bold">B</span>
                    <span className="text-white font-semibold text-lg">Battery</span>
                  </div>
                </div>
              </div>

              {/* Third Digit - Job Type */}
              <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-indigo-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-indigo-400 mr-3 text-xl font-bold">G</span>
                    <span className="text-white font-semibold text-lg">Goods</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-indigo-400 mr-3 text-xl font-bold">P</span>
                    <span className="text-white font-semibold text-lg">Passenger</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-indigo-400 mr-3 text-xl font-bold">M</span>
                    <span className="text-white font-semibold text-lg">Mixed</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-indigo-400 mr-3 text-xl font-bold">S</span>
                    <span className="text-white font-semibold text-lg">Shunting</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-indigo-400 mr-3 text-xl font-bold">U</span>
                    <span className="text-white font-semibold text-lg">Multiple units</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">W - Broad gauge</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-purple-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🔍</span>
                    <span className="text-gray-200 text-lg">D - Diesel</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-purple-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🔍</span>
                    <span className="text-gray-200 text-lg">M - Mixed (Passenger & Goods)</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-purple-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🔍</span>
                    <span className="text-gray-200 text-lg">3A - 3100 hp</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <h2 className="lg:text-3xl text-2xl font-bold text-white mb-8 flex items-center justify-center">
              <span className="bg-gradient-to-r from-pink-500 to-rose-500 p-4 rounded-full mr-4 shadow-lg">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-pink-400 mr-4">TI</span>
                  <h3 className="text-xl font-bold text-white">Trip Inspection</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 2 hours</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-pink-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">After 4500 kms or one trip</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-rose-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-rose-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-rose-400 mr-4">IA</span>
                  <h3 className="text-xl font-bold text-white">IA Maintenance</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 4 hours</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-rose-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">Periodicity: 60 days</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-red-400 mr-4">IC</span>
                  <h3 className="text-xl font-bold text-white">IC Maintenance</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-red-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 8 hours</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-red-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">Periodicity: 120 days</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-orange-400 mr-4">AOH</span>
                  <h3 className="text-xl font-bold text-white">AOH Maintenance</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-orange-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 6 working days</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-orange-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">18 months + 15 days (WAP-4 & WAG-5)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-500/20 to-amber-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-yellow-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-yellow-400 mr-4">IOH</span>
                  <h3 className="text-xl font-bold text-white">IOH Maintenance</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-yellow-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 9 working days</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-yellow-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">36 months + 1 month or 6 lakh km</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-amber-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-4">
                  <span className="text-2xl font-bold text-amber-400 mr-4">POH</span>
                  <h3 className="text-xl font-bold text-white">POH Maintenance</h3>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-amber-400 mr-3 text-xl">⏱️</span>
                    <span className="text-white font-semibold text-lg">Duration: 24 working days</span>
                  </div>
                  <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                    <span className="text-amber-400 mr-3 text-xl">🔄</span>
                    <span className="text-white font-semibold text-lg">6 years + 3 months or 15 lakh km</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-green-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                  ...
                  <span className="text-gray-200 text-lg">Adequate powering for train service</span>
                </div>
                <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                  <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🚀</span>
                  <span className="text-gray-200 text-lg">Permitted speed considerations</span>
                </div>
                <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                  <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🔧</span>
                  <span className="text-gray-200 text-lg">Maintenance schedule time slots</span>
                </div>
                <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                  <span className="text-green-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">⛽</span>
                  <span className="text-gray-200 text-lg">Fueling slots for diesel locos</span>
                </div>
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                ...
                <span className="text-gray-200 text-lg">Systematic locomotive classification</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔧</span>
              ...
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📊</span>
                <span className="text-gray-200 text-lg">Efficient loco link management</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">⚡</span>
                <span className="text-gray-200 text-lg">Optimum power utilization</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔄</span>
                <span className="text-gray-200 text-lg">Strategic resource planning</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📋</span>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-teal-400/30">
