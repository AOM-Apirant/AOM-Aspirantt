        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-blue-400/30">
              <p className="text-gray-200 text-lg leading-relaxed">
                Freight Transportation involves movement of raw material from production centers to industries and semi-finished/finished goods to consuming areas. It plays an important role in economic and industrial development of a country. The freight business is the major source of revenue for the Indian Railways. Main activity centers of freight operation include sidings, goods sheds and examination yards.
              </p>
            </div>
          </div>
              ...
              <div className="bg-gradient-to-br from-amber-500/20 to-yellow-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-amber-400/30">
                ...
                <div className="space-y-4">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                    ...
                    <span className="text-gray-200">Higher hauling power for loaded trains</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                    <span className="text-amber-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">🔄</span>
                    <span className="text-gray-200">Do not work in specific links except captive circuits</span>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-yellow-400/30">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                    ...
                    <span className="text-gray-200">Load chart provides section-wise tabulation for various locomotive combinations</span>
                  </div>
                  <div className="flex items-start group hover:bg-white/10 rounded-lg p-3 transition-all duration-300">
                    <span className="text-yellow-400 mr-3 mt-1 text-lg group-hover:scale-110 transition-transform">📋</span>
                    <span className="text-gray-200">Power plan prepared annually based on previous year&apos;s train operations</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Open Wagons */}
              <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-emerald-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Open Wagons</h3>
                <p className="text-gray-200 text-sm">Carry coal, ores, limestone. Can be tippled or unloaded through flap doors.</p>
              </div>

              {/* Covered Wagons */}
              <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-teal-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Covered Wagons</h3>
                <p className="text-gray-200 text-sm">For goods prone to atmospheric damage like grains, cement, fertilizers.</p>
              </div>

              {/* Flat Wagons */}
              <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-cyan-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Flat Wagons</h3>
                <p className="text-gray-200 text-sm">For steel coils, rail sleepers. No side walls.</p>
              </div>

              {/* Container Wagons */}
              <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Container Wagons</h3>
                <p className="text-gray-200 text-sm">Special flat wagons for containers with semi-permanent coupling.</p>
              </div>

              {/* Hopper Wagons */}
              <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-indigo-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Hopper Wagons</h3>
                <p className="text-gray-200 text-sm">Rapid discharge from bottom for coal and ballast.</p>
              </div>

              {/* Well Wagons */}
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Well Wagons</h3>
                <p className="text-gray-200 text-sm">Well-shaped under frame for military tanks, heavy equipment.</p>
              </div>

              {/* Tank Wagons */}
              <div className="bg-gradient-to-br from-pink-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Tank Wagons</h3>
                <p className="text-gray-200 text-sm">For liquid consignments like petroleum, milk, edible oils.</p>
              </div>

              {/* Automobile Carriers */}
              <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-lg font-bold text-white mb-3">Automobile Carriers</h3>
                <p className="text-gray-200 text-sm">Specially designed for automobiles. Modified coaches called NMGs.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-cyan-400/30">
              <p className="text-gray-200 text-lg leading-relaxed mb-6">
                Every zonal railway of IR has been allotted with a fleet of freight wagons by the Directorate of Wagon Interchange (DWI) under the IRCA for coordinating wagon interchanges. Of these, most wagons are contributed to the general pool. Zones are restricted to maintain their wagon balances proportionate to their contribution to the general pool of wagons.
              </p>
              <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-4 border border-blue-400/30">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-green-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Closed Circuit Examination</h3>
                <p className="text-gray-200 text-sm">Valid for higher number of days, can be loaded multiple times before subsequent examination.</p>
              </div>
              <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-emerald-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Premium Examination</h3>
                <p className="text-gray-200 text-sm">High-priority examination for specific wagon types and operations.</p>
              </div>
              <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-teal-400/30">
                <h3 className="text-xl font-bold text-white mb-4">End to End Examination</h3>
                <p className="text-gray-200 text-sm">Comprehensive examination covering all aspects of wagon condition.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-orange-400/30">
                <h3 className="text-2xl font-bold text-white mb-4">Customer Registration</h3>
                <p className="text-gray-200 text-lg leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-red-400/30">
                  <h3 className="text-xl font-bold text-white mb-4">Traffic Classes</h3>
                ...
                <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-pink-400/30">
                  <h3 className="text-xl font-bold text-white mb-4">Special Considerations</h3>
                  <div className="space-y-2">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-teal-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-teal-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Unloading</h3>
                <p className="text-gray-200 text-sm">All on hand inward wagons placed for unloading in time to achieve maximum unloading.</p>
              </div>
              <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-cyan-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Handing Over</h3>
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-blue-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Power Planning</h3>
                <p className="text-gray-200 text-sm">Planning appropriate locomotives to clear wagons with minimum terminal detentions.</p>
              </div>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-indigo-400/30">
                <h3 className="text-xl font-bold text-white mb-4">Planning/Forecasting</h3>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-purple-400/30">
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-pink-400/30">
