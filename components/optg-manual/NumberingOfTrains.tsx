      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 lg:px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl lg:p-8 p-4 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-4 p-3 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  ...
                  <span className="text-white font-semibold lg:text-lg text-base">Five-Digit System</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg lg:p-4 p-3 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <span className="text-orange-400 mr-3 lg:text-xl text-lg">🎯</span>
                  <span className="text-white font-semibold lg:text-lg text-base">Unique Identification</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-red-400 mr-4">0</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Special Trains</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-pink-400 mr-4">1</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Long Distance Trains</h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Rajdhani</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Shatabdi</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Jan Sadharan</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Sampark Kranti</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Garib Rath</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Duronto</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4 text-center">
                  <span className="lg:text-3xl text-2xl font-bold text-purple-400 mr-4">2</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Additional Long Distance Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-indigo-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-indigo-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-indigo-400 mr-4">3</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Kolkata Suburban Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-blue-400 mr-4">4</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Metropolitan Suburban Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base mb-4">
                  Suburban train services in Chennai, New Delhi, Secunderabad, and other metropolitan areas across India.
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Chennai</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">New Delhi</span>
                  <span className="bg-white/10 px-3 py-1 rounded-md text-sm text-gray-200">Secunderabad</span>
                </div>
              </div>

              {/* Passenger Trains */}
              <div className="bg-gradient-to-br from-cyan-500/20 to-teal-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-cyan-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-cyan-400 mr-4">5</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Passenger Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
              ...
              {/* MEMU Trains */}
              <div className="bg-gradient-to-br from-teal-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-teal-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-teal-400 mr-4">6</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">MEMU Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
              ...
              {/* DMU/DEMU Services */}
              <div className="bg-gradient-to-br from-emerald-500/20 to-green-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-emerald-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-emerald-400 mr-4">7</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">DMU/DEMU & Railcar Services</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
              ...
              {/* Mumbai Suburban */}
              <div className="bg-gradient-to-br from-green-500/20 to-yellow-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-green-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-green-400 mr-4">9</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Mumbai Area Suburban Trains</h3>
                </div>
                <p className="text-gray-200 leading-relaxed lg:text-lg text-base">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 lg:px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Konkan Railway */}
              <div className="bg-gradient-to-br from-yellow-500/20 to-amber-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-yellow-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-yellow-400 mr-4">0</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Konkan Railway</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-amber-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-amber-400 mr-4">1</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">CR, WCR, NCR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-orange-400 mr-4">2</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">Special Category</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-red-400 mr-4">3</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">ER, ECR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-pink-400 mr-4">4</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">NR, NCR, NWR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">  
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-purple-400 mr-4">5</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">NER, NFR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-indigo-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-indigo-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-indigo-400 mr-4">6</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">SR, SWR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-blue-400 mr-4">7</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">SCR, SWR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-cyan-500/20 to-teal-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-cyan-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-cyan-400 mr-4">8</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">SER, ECoR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
              ...
              <div className="bg-gradient-to-br from-teal-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl lg:p-6 p-4 shadow-lg border border-teal-400/30 hover:shadow-xl transition-all duration-300">
                <div className="flex lg:flex-row flex-col gap-4 items-center mb-4">
                  <span className="lg:text-3xl text-2xl font-bold text-teal-400 mr-4">9</span>
                  <h3 className="lg:text-xl text-lg font-bold text-white">WR, NWR, WCR</h3>
                </div>
                <p className="text-gray-200 lg:text-lg text-base">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 lg:px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1">
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">🔢</span>
                <span className="text-gray-200 lg:text-lg text-base">Systematic five-digit numbering</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">🎯</span>
                <span className="text-gray-200 lg:text-lg text-base">Unique train identification</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">🏢</span>
                <span className="text-gray-200 lg:text-lg text-base">Zonal railway classification</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">📊</span>
                <span className="text-gray-200 lg:text-lg text-base">Train type categorization</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">🔄</span>
                <span className="text-gray-200 lg:text-lg text-base">Standardized since 2010</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl lg:p-6 p-3 transition-all duration-300">
                <span className="text-emerald-400 mr-4 mt-1 lg:text-xl text-lg group-hover/feature:scale-110 transition-transform">📋</span>
                <span className="text-gray-200 lg:text-lg text-base">Comprehensive coverage</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl lg:p-8 p-4 shadow-xl border border-white/20">
            <h3 className="lg:text-3xl text-2xl font-bold text-center text-white mb-8 flex lg:flex-row flex-col gap-4 items-center justify-center">
              <span className="w-4 h-4 bg-gradient-to-br from-orange-500 to-red-500 rounded-full mr-3 animate-pulse"></span>
              Summary
            </h3>
            <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl lg:p-8 p-4 shadow-lg border border-orange-400/30">
