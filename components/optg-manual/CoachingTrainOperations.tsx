      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="lg:text-6xl text-3xl font-bold bg-gradient-to-r from-white via-purple-100 to-pink-100 bg-clip-text text-transparent mb-6 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  ...
                  <span className="text-white font-semibold text-lg">Maximum Satisfaction</span>
                </div>
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
                  <span className="text-purple-400 mr-3 text-xl">⏰</span>
                  <span className="text-white font-semibold text-lg">Punctual Running</span>
                </div>
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Semi high speed up to 160kmph</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-purple-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🪑</span>
                    <span className="text-gray-200 text-lg">Latest passenger friendly features</span>
                  </div>
                </div>
              </div>

              {/* Rajdhani */}
              <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-pink-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Elite trains with highest priority</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
              ...
              {/* Shatabdi */}
              <div className="bg-gradient-to-br from-rose-500/20 to-red-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-rose-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Connect state capitals</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-rose-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">⏱️</span>
                    <span className="text-gray-200 text-lg">6-8 hours travel time</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Non-stop superfast trains</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-red-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🎨</span>
                    <span className="text-gray-200 text-lg">Unique yellow green livery</span>
                  </div>
                </div>
              </div>

              {/* Sampark Kranti */}
              <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-orange-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Revolution in public contact</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-orange-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🏙️</span>
                    <span className="text-gray-200 text-lg">Connect cities with National Capital</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-500/20 to-amber-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-yellow-400/30 hover:shadow-xl transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-lg">Average speed 55kmph+</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-4 transition-all duration-300">
                    <span className="text-yellow-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">⭐</span>
                    <span className="text-gray-200 text-lg">Premium features and limited halts</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-10 px-8 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                ...
                <span className="text-gray-200 text-lg">Maximum passenger satisfaction</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-cyan-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">⏰</span>
                <span className="text-gray-200 text-lg">Punctual running and timetabling</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-cyan-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🚄</span>
                <span className="text-gray-200 text-lg">Diverse service types for different needs</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-cyan-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">💰</span>
                <span className="text-gray-200 text-lg">Affordable to premium pricing options</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-cyan-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🏙️</span>
                <span className="text-gray-200 text-lg">Connectivity across all regions</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-xl p-6 transition-all duration-300">
                <span className="text-cyan-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔄</span>
                <span className="text-gray-200 text-lg">Systematic and regular operations</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-8 shadow-lg border border-purple-400/30">
