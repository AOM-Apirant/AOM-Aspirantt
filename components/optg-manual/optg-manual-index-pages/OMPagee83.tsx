                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-blue-400 text-sm font-bold">1.</span>
                        <span className="text-white text-sm">Splashed grease marks on wheels</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-blue-400 text-sm font-bold">2.</span>
                        <span className="text-white text-sm">Smell of Burning grease</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-blue-400 text-sm font-bold">3.</span>
                        <span className="text-white text-sm">Smoke from the Axle Box</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-blue-400 text-sm font-bold">4.</span>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-cyan-400 text-sm font-bold">5.</span>
                        <span className="text-white text-sm">Red glow of Axle Box (visible during night)</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-cyan-400 text-sm font-bold">6.</span>
                        <span className="text-white text-sm">Whistling sound or metallic screech</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-cyan-400 text-sm font-bold">7.</span>
                        <span className="text-white text-sm">Flames coming out from Axle Box</span>
                      </div>
                      <div className="flex items-start">
                        <span className="flex-shrink-0 mt-1 mr-2 text-cyan-400 text-sm font-bold">8.</span>
