          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-purple-400/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  {/* Second Digit */}
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300 border border-white/20">
                    <h4 className="font-semibold text-pink-300 mb-4 flex items-center">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-indigo-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-indigo-400/30">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300 border border-white/20">
                  <h4 className="font-semibold text-indigo-300 mb-4 flex items-center">
                    <Clock className="w-5 h-5 mr-2" />
                    ...
                    <table className="w-full text-sm text-gray-200">
                      <thead>
                        <tr className="border-b border-white/20">
                          <th className="text-left p-3 font-semibold text-indigo-200">Schedule</th>
                          <th className="text-left p-3 font-semibold text-blue-200">Duration</th>
                          <th className="text-left p-3 font-semibold text-indigo-200">Periodicity</th>
                        </tr>
                      </thead>
                      <tbody className="space-y-2">
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-indigo-100">Trip inspection (TI)</td>
                          <td className="p-3">2 hrs</td>
                          <td className="p-3">After 4500 kms or one trip whichever is later</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-blue-100">IA</td>
                          <td className="p-3">4 hrs</td>
                          <td className="p-3">60 days</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-indigo-100">IC</td>
                          <td className="p-3">8 hrs</td>
                          <td className="p-3">120 days</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-blue-100">AOH</td>
                          <td className="p-3">6 working days</td>
                          <td className="p-3">
                            <div>18 months + 15 days (WAP-4 & WAG-5)</div>
                            <div>12 months + 15 days (WAP-1)</div>
                          </td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-indigo-100">IOH</td>
                          <td className="p-3">9 working days</td>
                          <td className="p-3">
                            <div>36 months + 1 month or 6 lakh km, whichever is earlier (WAP-1 & WAG-5)</div>
                            <div>54 months (4 ½ years) + 1 month or 9 lakh km, whichever is earlier (WAP-4)</div>
                          </td>
                        </tr>
                        <tr>
                          <td className="p-3 font-medium text-blue-100">POH</td>
                          <td className="p-3">24 working days</td>
                          <td className="p-3">
                            <div>6 years + 3 months or 15 lakh km, whichever is earlier (WAP-1 & WAG-5)</div>
                            <div>108 months (9 years) + 3 months or 18 lakh km, whichever is earlier (WAP-4)</div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-pink-500/20 to-rose-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-pink-400/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300 border border-white/20">
                    <h4 className="font-semibold text-rose-300 mb-4 flex items-center">
                      <Award className="w-5 h-5 mr-2" />
                      Special Service Codes
                    </h4>
                    <div className="space-y-3 text-sm text-gray-200">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-emerald-500/20 to-green-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-emerald-400/30">
                ...
                {/* Policy Guidelines */}
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300 border border-white/20 mt-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm text-gray-200">
                      <thead>
                        <tr className="border-b border-white/20">
                          <th className="text-left p-3 font-semibold text-emerald-200">S.No</th>
                          <th className="text-left p-3 font-semibold text-green-200">Trains Description</th>
                          <th className="text-left p-3 font-semibold text-emerald-200">Primary Maintenance</th>
                        </tr>
                      </thead>
                      <tbody className="space-y-2">
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">1</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Rajdhani / Duranto</div>
                          </td>
                          <td className="p-3">At both originating and destination stations</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">2</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">M/Express round trip more than 3500km for ICF / 4000km for LHB stock</div>
                          </td>
                          <td className="p-3">At both originating and destination stations</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">3</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">M/Express round trip up to 3500km for ICF / 4000km for LHB stock and touch primary depot within validity</div>
                          </td>
                          <td className="p-3">At Primary end only once within the limit of 3500 Kms (ICF) or 4000 Kms (LHB) / 96 Hrs. whichever is earlier.</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">4</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Interconnected Mail/Express Trains Round trip run up to 3500 Kms (ICF) or 4000 Kms (LHB)</div>
                          </td>
                          <td className="p-3">To be done within 3500 Kms (ICF) or 4000 Kms (LHB) or 96 hours after the issue of original BPC whichever is earlier, only at Primary end.</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">5</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Passenger trains with toilets including interconnected passenger trains/ shuttles</div>
                          </td>
                          <td className="p-3">Done within 3500 Kms or 96 hours after the issue of original BPC whichever is earlier, only at Primary end.</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">6</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Passenger trains without toilets</div>
                          </td>
                          <td className="p-3">To be done after 3500 Kms or 7 days whichever is earlier, only at Primary end</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">7</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Dedicated Parcel Trains</div>
                          </td>
                          <td className="p-3">To be done after 4500 Kms or 10 days whichever is earlier.</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-emerald-100">8</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">Military/Election Special trains</div>
                          </td>
                          <td className="p-3">To be done within 3500 KMs (ICF) or 4000 KMS (LHB) or 96 hours whichever is earlier. Other end under gear examination may be permitted only once.</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-medium text-emerald-100">9</td>
                          <td className="p-3">
                            <div className="font-medium text-green-100">DEMU/MEMU/EMU*</div>
                          </td>
                          <td className="p-3">
                            At the maintenance shed during every trip Inspection. 7 days periodicity for 700 HP units; 10 days periodicity - other units.
                            <div className="text-xs text-gray-300 mt-1">*At present BPC for EMU is being given for 14 days instead of 10 days.</div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300 border border-white/20 mb-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm text-gray-200">
                      <thead>
                        <tr className="border-b border-white/20">
                          <th className="text-left p-3 font-semibold text-blue-200">Type of Stock</th>
                          <th className="text-left p-3 font-semibold text-indigo-200">Traffic</th>
                          <th className="text-left p-3 font-semibold text-blue-200">Mechanical</th>
                          <th className="text-left p-3 font-semibold text-indigo-200">Total</th>
                        </tr>
                      </thead>
                      <tbody className="space-y-2">
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-blue-100">AC coaches</td>
                          <td className="p-3">5%</td>
                          <td className="p-3">6%</td>
                          <td className="p-3 font-semibold text-blue-200">11%</td>
                        </tr>
                        <tr className="border-b border-white/10">
                          <td className="p-3 font-medium text-blue-100">Non AC coaches</td>
                          <td className="p-3">4%</td>
                          <td className="p-3">5%</td>
                          <td className="p-3 font-semibold text-blue-200">9%</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-medium text-blue-100">Rajdhani/Shatabdi</td>
                          <td className="p-3">5%</td>
                          <td className="p-3">6%</td>
                          <td className="p-3 font-semibold text-blue-200">11%</td>
                        </tr>
