      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="lg:text-6xl text-2xl font-bold bg-gradient-to-r from-white via-blue-100 to-indigo-100 bg-clip-text text-transparent mb-6 animate-fade-in text-center"> 
              WORKING OF TRAINS
            </h1>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-blue-400/30 hover:shadow-xl transition-all duration-300">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="flex items-center bg-white/10 backdrop-blur-sm rounded-lg py-4 px-2 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 border border-white/20">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="space-y-8">
              {/* Locomotive */}
              <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-lg rounded-lg py-4 px-2 shadow-lg border border-emerald-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center justify-center gap-4 flex-col text-center">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-base">Provides motive power for hauling</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    <span className="text-emerald-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🔧</span>
                    <span className="text-gray-200 text-base">Steam → Diesel → Electric evolution</span>
                  </div>
                </div>
              </div>

              {/* Formation */}
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-lg py-4 px-2 shadow-lg border border-purple-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center justify-center gap-4 flex-col text-center">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-base">Marshaling order for safety</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    <span className="text-purple-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">📋</span>
                    <span className="text-gray-200 text-base">Brake Power Certificate required</span>
                  </div>
                </div>
              </div>

              {/* Train Sets */}
              <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-lg rounded-lg py-4 px-2 shadow-lg border border-amber-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center justify-center gap-4 flex-col text-center">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-base">Integrated engines in formation</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    <span className="text-amber-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">⚡</span>
                    <span className="text-gray-200 text-base">Faster acceleration/deceleration</span>
                  </div>
                </div>
              </div>

              {/* Crew */}
              <div className="bg-gradient-to-br from-red-500/20 to-pink-500/20 backdrop-blur-lg rounded-lg py-4 px-2 shadow-lg border border-red-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center justify-center gap-4 flex-col text-center">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    ...
                    <span className="text-gray-200 text-base">Loco pilots & Assistant Loco Pilots</span>
                  </div>
                  <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                    <span className="text-red-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform duration-300">🛡️</span>
                    <span className="text-gray-200 text-base">Guards & Motorman</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {/* Train Ordering */}
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-lg py-4 px-2 shadow-lg border border-green-400/30 hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center justify-center gap-4 flex-col text-center">
                ...
                <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                  ...
                  <span className="text-gray-200 text-base">Section controllers order through train advice/notice</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-8 px-4 mb-12 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                ...
                <span className="text-gray-200 text-base">Competent crew operation with proper training</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                <span className="text-indigo-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📊</span>
                <span className="text-gray-200 text-base">Systematic approach to railway transportation</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                <span className="text-indigo-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔒</span>
                <span className="text-gray-200 text-base">Safety-first approach with proper signaling</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                <span className="text-indigo-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">⚡</span>
                <span className="text-gray-200 text-base">Efficient path utilization and scheduling</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                <span className="text-indigo-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">📋</span>
                <span className="text-gray-200 text-base">Comprehensive documentation and certification</span>
              </div>
              <div className="flex items-start group/feature hover:bg-white/10 rounded-lg p-2 transition-all duration-300">
                <span className="text-indigo-400 mr-4 mt-1 text-xl group-hover/feature:scale-110 transition-transform">🔄</span>
                <span className="text-gray-200 text-base">Continuous monitoring and control systems</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-4 shadow-xl border border-white/20">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-lg rounded-lg p-4 shadow-lg border border-blue-400/30">
