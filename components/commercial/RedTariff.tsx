      ...
      <div className="relative z-10 py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 px-6 mb-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            <div className="bg-gradient-to-r from-red-600/20 to-pink-600/20 rounded-xl p-6 border border-red-500/30 max-h-96 overflow-y-auto">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Absolute alcohol</span>
                    <span className="text-pink-300 font-semibold">III 106</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acetic Anhydride</span>
                    <span className="text-pink-300 font-semibold">VIII 293</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acetic Ether</span>
                    <span className="text-pink-300 font-semibold">III 103</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Aceto Arsenite of Copper</span>
                    <span className="text-pink-300 font-semibold">VI 200</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acetone</span>
                    <span className="text-pink-300 font-semibold">III 106</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acetyl Chloride</span>
                    <span className="text-pink-300 font-semibold">VIII 292</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acetylene</span>
                    <span className="text-pink-300 font-semibold">II 70</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Acetic</span>
                    <span className="text-pink-300 font-semibold">VIII 292</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Carbolic</span>
                    <span className="text-pink-300 font-semibold">VI 199</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Chlorosulphonic</span>
                    <span className="text-pink-300 font-semibold">VIII 293</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Chromic</span>
                    <span className="text-pink-300 font-semibold">VIII 294</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Cresylic</span>
                    <span className="text-pink-300 font-semibold">VI 199</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Formic</span>
                    <span className="text-pink-300 font-semibold">VIII 296</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Hydrobromic</span>
                    <span className="text-pink-300 font-semibold">VIII 296</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Hydrochloric</span>
                    <span className="text-pink-300 font-semibold">VIII 297</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Hydrofluoric</span>
                    <span className="text-pink-300 font-semibold">VIII 298</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid Nitric</span>
                    <span className="text-pink-300 font-semibold">VIII 298</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Oxalic</span>
                    <span className="text-pink-300 font-semibold">VI 200</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid Perchloric</span>
                    <span className="text-pink-300 font-semibold">VIII 299</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Phosphoric</span>
                    <span className="text-pink-300 font-semibold">VIII 300</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Propoinic</span>
                    <span className="text-pink-300 font-semibold">VIII 300</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Sludge</span>
                    <span className="text-pink-300 font-semibold">VIII 303</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Sulfamic</span>
                    <span className="text-pink-300 font-semibold">VI 199</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Sulphuric</span>
                    <span className="text-pink-300 font-semibold">VIII 300</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Sulphuric, diluted</span>
                    <span className="text-pink-300 font-semibold">VIII 303</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Acid, Sulphurous</span>
                    <span className="text-pink-300 font-semibold">VIII 303</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Aeromex oil</span>
                    <span className="text-pink-300 font-semibold">III 126</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Agrosan G.N.</span>
                    <span className="text-pink-300 font-semibold">VI 211</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Air compressed</span>
                    <span className="text-pink-300 font-semibold">II 70</span>
                  </div>
                  <div className="flex justify-between hover:bg-white/5 p-2 rounded transition-colors">
                    <span className="text-gray-200">Alpha Napthyl Thiourea</span>
                    <span className="text-pink-300 font-semibold">VI 200</span>
                  </div>
                </div>
              </div>
              <div className="mt-6 text-center">
                <p className="text-gray-300 text-sm">... and many more commodities listed in the complete Red Tariff document</p>
                <p className="text-pink-300 font-semibold mt-2">Total: 500+ commodities across 8 chapters</p>
              </div>
            </div>
          </div>
