        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-4 px-3 shadow-lg border border-orange-400/30">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-200 lg:text-base text-sm leading-relaxed">
                      <span className="text-orange-300 font-semibold">Note.-</span> The leave granted as preparatory to retirement shall not include extraordinary leave.
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 540
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule540