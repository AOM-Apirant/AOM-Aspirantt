        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed">In the case of persons re-employed after retirement the provisions of these rules shall apply as if he had entered railway service for the first time on the date of his re-employment.</span>
                  </li>
                  <li className="flex items-start gap-4">
                    ...
                    <div className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      <ul className="space-y-4 ml-6">
                        <li className="flex items-start gap-3">
                          <span className="text-cyan-200 font-semibold mt-1">(a)</span>
                          <span>If a railway servant, who quits the public service on compensation or invalid pension or gratuity, is re-employed and if his gratuity is thereupon refunded or his pension held wholly in abeyance his past service thereby becoming pensionable on ultimate retirement, he may at the discretion of the authority sanctioning the re-employment and to such extent as that authority may decide count his former service towards leave.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <span className="text-cyan-200 font-semibold mt-1">(b)</span>
                          <span>A railway servant who is dismissed or removal from the public service but is reinstated on appeal or revision is entitled to count his former service for leave.</span>
                        </li>
                      </ul>
                    </div>
                  </li>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 538
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule538