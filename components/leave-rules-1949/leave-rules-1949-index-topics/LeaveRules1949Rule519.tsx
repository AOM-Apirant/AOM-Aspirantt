        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 519
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule519