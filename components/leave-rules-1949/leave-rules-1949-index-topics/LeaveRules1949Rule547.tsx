        ...
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-4 px-3 shadow-lg border border-orange-400/30">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="text-orange-300 font-semibold">Railway Board&apos;s decision.-</span> It is clarified that the last pay drawn in such cases will be inclusive of Special pay.(Railway Board&apos;s letter No. E(P&A)I-76/CPC/LE-01 dt. 19-01-1984/CS-06)
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 547
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule547