        ...
        <div className="max-w-7xl mx-auto">
                  ...
                  <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-4 px-3 shadow-lg border border-orange-400/30">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="text-orange-300 font-semibold">Note 1.-</span> Journeymen and similar other apprentices/trainees recruited for initial training on the Railways before they are appointed against the working posts in Group C service, during the period of their training may be granted leave under this rule.
                      </span>
                    </div>
                  </div>
                  <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-4 px-3 shadow-lg border border-orange-400/30">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-gray-200 lg:text-base text-sm leading-relaxed">
                        <span className="text-orange-300 font-semibold">Note 2.-</span> Leave to probationary Assistant Station Masters and Commercial Clerks and all others who are trained for employment and are not put on the time scale during the period of training shall be regulated under this rule.
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 533
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule533