        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-6 lg:px-4 px-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-orange-400/30">
                <div className="flex items-start gap-4">
                  ...
                  <span className="text-gray-200 lg:text-lg text-base leading-relaxed">
                    This does not apply to casual literacy work, or to service as an examiner or similar employment; nor does it apply to acceptance of foreign service with the sanction of the competent authority.
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 509
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule509