        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg rounded-xl py-6 lg:px-4 px-3 shadow-lg border border-blue-400/30">
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <span className="text-gray-200 lg:text-lg text-base leading-relaxed">
                      Wilful absence from duty after the expiry of leave renders a railway servant liable to disciplinary action.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-300">
              Railway Services (Liberalised Leave) Rules, 1949 - Rule 518
            </p>
          </div>
        </div>
      </div>
...
export default LeaveRules1949Rule518