      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-indigo-300 mb-4">REPORTING OF ACCIDENTS ON CONSTRUCTION LINES</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-indigo-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Procedures for reporting accidents on railway construction lines and coordination with officials
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">419</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                      ...
                      Reporting of Accidents on Construction lines
                    </h3>
                  </div>
                </div>
              </div>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Chief Safety Officer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Principal Chief Engineer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Chief Mechanical Engineer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Chief Signal and Tele-communication Engineer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Chief Electrical Engineer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Chief Medical Officer</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Medical Superintendent</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-200">Divisional Medical Officer</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    
                    {/* Note about Government Officials */}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-amber-200 font-medium">
                            <span className="font-bold">Note:</span> Regarding Government Officials, the usual procedure shall be followed.
                          </p>
                        </div>
                      </div>
                    </div>
...
export default AMChapterPage39H