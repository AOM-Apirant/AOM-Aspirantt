                          ...
                          <div className="space-y-4">
                            <div className="space-y-3">
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  <span className="text-white">Commercial control plays a very important role in organizing rescue, and restoration in all types of accidents and, more so, in case of accidents involving casualties/injuries. Unlike other controls in control office commercial control is normally manned by a single employee. In case of an accident, this single person cannot handle all the myriad jobs of commercial control. Therefore, one of the first duties of Sr.DCM/DCM is to strengthen commercial control by posting one commercial officer and 3 or 4 commercial inspectors round the clock till restoration is completed.</span>
                                </div>
                              </div>
                            </div>
                          </div>
