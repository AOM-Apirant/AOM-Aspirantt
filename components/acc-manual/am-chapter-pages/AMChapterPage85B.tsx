                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">623</span>
                    </div>
                  </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-4">
                          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                            <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">Training Guidelines</h4>
                          </div>
                          
                          <p className="text-gray-200 leading-relaxed">
                            Training may be conducted on the following lines:
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-orange-400/30">
                              <h4 className="text-lg font-bold text-orange-300 mb-3 text-center">a. Individual Training</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Individual Training for enhancing the skill of the staff attached to Accident Relief Train, general training to Engineering staff, OHE Staff and all Supervisors in Disaster Management.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-cyan-400/30">
                              <h4 className="text-lg font-bold text-cyan-300 mb-3 text-center">b. Seminars</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Seminars on disaster preparedness / action plan shall be conducted periodically.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/30">
                              <h4 className="text-lg font-bold text-yellow-300 mb-3 text-center">c. Joint Exercises</h4>
                            </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/30">
                              <h4 className="text-lg font-bold text-indigo-300 mb-3 text-center">d. Simulation Exercises</h4>
                            </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-pink-500/20 to-red-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-pink-400/30">
                              <h4 className="text-lg font-bold text-pink-300 mb-3 text-center">e. Skeleton Exercises</h4>
                            </div>
                            
                            <p className="text-gray-200 leading-relaxed">
                              Skeleton exercises - various units shall arrange mock drill.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default AMChapterPage85B