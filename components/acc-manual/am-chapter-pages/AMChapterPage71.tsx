                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">605</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                      ...
                      Stations where Medical Relief Equipment (Scale-I & Scale-II) are Located
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-6">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/20 lg:p-6 py-3 lg:px-4 px-2">
                    ...
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-4">
                      <h5 className="text-lg font-bold text-green-300 text-center">(BROAD GAUGE)</h5>
                    </div>

                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                        ...
                        <div className="ml-6 space-y-2">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-200">Scale: <span className="text-blue-300 font-semibold">I</span></span>
                          </div>
                          <div className="flex items-start gap-2">
                            <span className="text-blue-400">◆</span>
                            <span className="text-gray-200">Self Propelled Accident Relief Medical Train (SPARMT)</span>
                          </div>
                          <div className="flex items-start gap-2">
                            <span className="text-blue-400">◆</span>
                            <span className="text-gray-200">Medical Van, Aux. Van</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                        ...
                        <div className="ml-6 space-y-2">
                          ...
                          <div className="flex items-start gap-2">
                            <span className="text-blue-400">◆</span>
                            <span className="text-gray-200">Medical Train</span>
                          </div>
                          <div className="flex items-start gap-2">
                            <span className="text-blue-400">◆</span>
                            <span className="text-gray-200">Medical Van, Aux. Van</span>
                    ...
                    {/* Vijayawada Division */}
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6 mt-6">
                      <h5 className="text-lg font-bold text-green-300 text-center">VIJAYAWADA DIVISION</h5>
                    </div>
                    <div className="space-y-4 mb-6">
                      ...
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                        ...
                        <div className="ml-6 space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-blue-400">🚑</span>
                            <span className="text-gray-200">Medical Relief Train (MRT), Medical Van, Auxiliary Van</span>
                          </div>
                        </div>
                      </div>
                      {/* Rajahmundry */}
                    ...
                    {/* Guntakal Division */}
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6">
                      <h5 className="text-lg font-bold text-green-300 text-center">GUNTAKAL DIVISION</h5>
                    </div>
                    <div className="space-y-4 mb-6">
                      {/* Dharmavaram */}
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                    ...
                    {/* Hyderabad Division */}
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6">
                      <h5 className="text-lg font-bold text-green-300 text-center">HYDERABAD DIVISION</h5>
                    </div>
                    <div className="space-y-4 mb-6">
                      {/* Nizamabad */}
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                    ...
                    {/* Nanded Division (BG) */}
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6">
                      <h5 className="text-lg font-bold text-green-300 text-center">NANDED DIVISION (BG)</h5>
                    </div>
                    <div className="space-y-4 mb-6">
                      {/* Purna */}
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                    ...
                    {/* Nanded Division (MG) */}
                    <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30 mb-6">
                      <h5 className="text-lg font-bold text-green-300 text-center">NANDED DIVISION (MG)</h5>
                    </div>
                    <div className="space-y-4 mb-6">
                      {/* Akola */}
                      <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-blue-400/20">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Secunderabad Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Mahabubnagar</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Nizamabad</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">3️⃣</span> Parli-vaijnath</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">4️⃣</span> Vikarabad</li>
                        </ul>
                      </div>
                      {/* Hyderabad Division */}
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Hyderabad Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Bellampalli</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Dornakal</li>
                        </ul>
                      </div>
                      {/* Nanded Division */}
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Nanded Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Jalna</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Kinwat</li>
                        </ul>
                      </div>
                      {/* Vijayawada Division */}
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Vijayawada Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Gudur</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Ongole</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">3️⃣</span> Eluru</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">4️⃣</span> Tuni</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">5️⃣</span> Bhimavaram</li>
                        </ul>
                      </div>
                      {/* Guntakal Division */}
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Guntakal Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Cuddapah</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Raichur</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">3️⃣</span> Nandalur</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">4️⃣</span> Madanapalle Road</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">5️⃣</span> Kadiri</li>
                        </ul>
                      </div>
                      {/* Guntur Division */}
                      <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 p-4 rounded-xl border border-pink-400/20">
                        <h5 className="font-semibold text-pink-300 mb-2 flex items-center gap-2">
                          <span className="text-pink-400">🚉</span> Guntur Division
                        </h5>
                        <ul className="list-none space-y-1 pl-0">
                          <li className="flex items-center gap-2"><span className="text-pink-400">1️⃣</span> Nadikudi</li>
                          <li className="flex items-center gap-2"><span className="text-pink-400">2️⃣</span> Nandyal</li>
                        </ul>
                      </div>
                    </div>
                    <div className="mt-8 space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-gray-200">
                          The Medical Van containing Scale I equipment is marked as <span className="font-semibold text-pink-200">&quot;Accident Relief Medical Equipment&quot;</span> and displays a Red Cross on each side against a white background. Each arm of the cross measures <span className="font-semibold">60 cm</span> long and <span className="font-semibold">15 cm</span> wide.
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-400 text-lg">🚪</span>
                        <span className="text-gray-200">
                          The special room containing Scale II equipment is marked on at least two sides with a Red Cross on a white background, as described above.
                        </span>
                      </div>
                      <div className="flex items-start gap-2">
                        <span className="text-pink-400 text-lg">📋</span>
                        <span className="text-gray-200">
                          A copy of the list enumerating the equipment in Scale I and II must be displayed on the wall inside the Medical Van and in the special room, respectively, for easy reference.
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-8">
                    ...
                    <ul className="list-none space-y-3 pl-0">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          The Medical Relief Train, comprising a Medical Van and an Auxiliary Van coupled together, must be stabled in a traffic yard siding with entry and exit preferably at both ends. This ensures quick dispatch in either direction. As both vans must depart within <span className="font-semibold">15 minutes</span> of being ordered, no delay or detention is permitted.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">🛠️</span>
                        <span>
                          At stations where staff familiar with Oxy-acetylene equipment and other tools cannot accompany the Auxiliary Van within the 15-minute target, trained TXR and Train Lighting staff available at the station should depart with the Medical Relief Train.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">⛔</span>
                        <span>
                          No other vehicles are allowed to be stabled on the line or siding reserved for Medical Relief Trains.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">🧑‍🔧</span>
                        <span>
                          All concerned departmental officials must ensure that Medical Relief Trains are always maintained in fit and ready condition.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-pink-400 mt-1">📝</span>
                        <span>
                          The points of the line where the Medical Relief Train is stabled must be tested weekly. Results should be recorded in the station diary, and any malfunction must be rectified by the maintenance staff. The Station Superintendent is responsible for ensuring regular testing.
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="mt-8 bg-pink-50/10 rounded-xl p-6 shadow-lg animate-fade-in">
                ...
                <ul className="list-none space-y-4 pl-0">
                  ...
                  <li>
                    ...
                    <span className="block mt-2 text-pink-700 font-medium">
                      Medical Officers and Sr.DSO / DSO are responsible for ensuring compliance with the irregularities notified in these inspection reports.
                    </span>
                  </li>
                </ul>
              </div>
...
export default AMChapterPage71