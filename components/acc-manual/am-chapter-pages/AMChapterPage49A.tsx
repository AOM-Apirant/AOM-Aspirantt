        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              EXAMINATION TO CERTIFY FITNESS FOR MOVEMENT OF LOCOMOTIVE AND ROLLING STOCK OF THE TRAINS INVOLVED IN ACCIDENT
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">502</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mt-1">
                        <span className="text-white font-bold text-sm">502.1</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="text-xl font-bold text-white mb-3">Locomotives ––</h4>
                        <div className="space-y-4">
                          <div className="flex items-start gap-3">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-200 leading-relaxed">
                                When locomotive of the accident involved train is not derailed or damaged, it can be permitted for restricted use based on visual examination and written certification by either ART supervisor/TXR or Loco Pilot (in that order), but its regular use should be permitted only after proper examination and fitness certification by the shed.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center mt-1">
                        <span className="text-white font-bold text-sm">502.2</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="text-xl font-bold text-white mb-3">Coaches ––</h4>
                        <div className="space-y-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-200 leading-relaxed">
                                Coaches of the accident involved train, if derailed or damaged should be permitted to move from the site of accident after visual examination and written certification by either ART supervisor/TXR or Loco Pilot & Guard (in that order). Depending upon the extent of damage, the coaches can be permitted, with or without speed restriction, upto the next station/yard or beyond, but should be permitted for regular use only after proper examination on pit line and fitness certification by TXR.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-200 leading-relaxed">
                                Other coaches of the accident involved trains, which are not derailed or damaged, can be permitted for restricted use based on visual examination and written certification by either ART supervisor/TXR or Loco Pilot & Guard (in that order) but their regular use should be permitted only after proper examination on pit line and fitness certification by the TXR
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-rose-500 to-pink-600 rounded-full flex items-center justify-center mt-1">
                        <span className="text-white font-bold text-sm">502.3</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="text-xl font-bold text-white mb-3">Wagons ––</h4>
                        <div className="space-y-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-gray-200 leading-relaxed">
                                Wagons of accident involved trains, affected or unaffected, should be permitted to move from the site of accident after visual examination and written certification by either ART supervisor/TXR or Loco Pilot & Guard (in that order) who may allow with or without speed restriction upto the next station/yard or beyond depending upon the extent of damage. Such wagons should be permitted for regular use only after intensive examination at the nearest TXR point.
                              </p>
                            </div>
                          </div>
                        </div>
...
export default AMChapterPage49A