                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">921</span>
                    </div>
                  </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-red-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-red-400/30">
                              <h4 className="text-lg font-bold text-red-300 mb-3 text-center">a) Failure of Railway Staff</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-orange-500/20 to-yellow-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-orange-400/30">
                              <h4 className="text-lg font-bold text-orange-300 mb-3 text-center">b) Failure of other than Railway staff</h4>
                            </div>
                            
                            <div className="text-gray-200 leading-relaxed space-y-2 ml-4">
                              <p>i. Tampering with the track.</p>
                              <p>ii. Other miscellaneous causes.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/30">
                              <h4 className="text-lg font-bold text-yellow-300 mb-3 text-center">c) Failure of equipment</h4>
                            </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                              <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">d) Sabotage</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30">
                              <h4 className="text-lg font-bold text-green-300 mb-3 text-center">e) Accidental or Act of God</h4>
                            </div>
                            
                            <div className="text-gray-200 leading-relaxed space-y-2 ml-4">
                              <p>i. Combination of factors.</p>
                              <p>ii. Other miscellaneous causes.</p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-gray-500/20 to-slate-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-gray-400/30">
                              <h4 className="text-lg font-bold text-gray-300 mb-3 text-center">f) Could not be established</h4>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMChapaterPage108C