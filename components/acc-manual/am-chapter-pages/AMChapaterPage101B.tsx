                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              The Central Government may appoint a Commission of Inquiry under the Commission of Inquiry Act, 1952 (LX of 1952) in a very serious accident. In such an event any other enquiry / investigation or other proceedings in relation to that accident shall be stopped and all records or other documents relating to such enquiry shall be forwarded to such authority as may be specified by the Central Government in this behalf.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              CRS shall hold statutory enquiry into the accidents falling under Section 113 of Railways Act 1989. The CRS may order and personally conduct an inquiry into an accident other than those falling under section 113 of Rly. Act, which he considers to be of sufficiently serious nature to justify such a course being adopted. The CRS shall inform the GM / CSO of his intention to hold an inquiry and shall at the same time, fix and communicate the date, time and place of the inquiry.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              It may be judicial or non-judicial and is appointed by the State Government. In case of reportable train accident, the District Magistrate or any other Magistrate may himself make an inquiry or depute a Subordinate Magistrate or direct the Police for investigation.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              The Railway Police may investigate the causes of accidents occurring during railway operations. If an accident results in loss of human life, grievous injury, serious damage to railway property exceeding Rs. 2 Crore, or appears to be due to any criminal act or omission, the Police Inquiry may proceed parallel to other inquiries if required.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              When an accident as defined in Section 113 of the Act occurs, the Head of the Railway Administration must promptly order a thorough investigation by a Committee of Railway Officers, known as a ‘Joint Inquiry’. In special cases, the General Manager may order Inter-departmental Inquiries, specifying the officers or senior subordinates for the committee and, if necessary, fixing the date.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              For accidents not under the purview of the Commissioner of Railway Safety (CRS), the Divisional Railway Manager (DRM) shall order an inquiry by a committee of officers from the relevant departments. If the General Manager deems it necessary, an inquiry by Heads of Departments (HODs) or Principal Heads of Departments (PHODs) may be ordered, in which case the DRM need not order a separate inquiry.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-4">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                              If the cause of the accident is clearly attributable to a particular department and the Head of that Department accepts responsibility, the inter-departmental committee inquiry may be dispensed with. In such cases, the inquiry can be conducted by an officer or officers of the concerned department to determine staff responsibility and recommend measures to prevent future accidents.
                            </p>
                          </div>
                        </div>
                      </div>
...
export default AMChapaterPage101B
