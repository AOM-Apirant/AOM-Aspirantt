        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Comprehensive procedures for compiling and reporting train accident returns to Railway Board
            </p>
          </div>
                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">421</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                      ...
                      Train Accident returns to be sent to the Railway Board
                    </h3>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">
                          Information about train accidents, yard accidents and indicative accidents that fall under classification A, B, C, D, E, F, G and H will be compiled by the Safety Branch of Divisions and Zonal Railways.
                        </p>
                      </div>
                    </div>
                  </div>
...
export default AMChapterPage41A