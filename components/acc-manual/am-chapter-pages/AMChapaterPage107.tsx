                ...
                <div className="flex flex-col gap-3 items-center space-y-4 relative">
                  <div className="flex-shrink-0">
                    <div className="lg:w-16 lg:h-16 w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 group-hover:scale-110 absolute top-0 right-0">
                      <span className="text-white font-bold lg:text-lg text-base">918</span>
                    </div>
                  </div>
                  <div className="flex-1">
                    <h3 className="lg:text-2xl text-xl font-bold text-white mb-4 flex flex-col gap-3 items-center justify-center text-center">
                      ...
                      Proceedings of Joint or Inter-departmental Inquiries
                    </h3>
                  </div>
                </div>
              </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-green-400/30">
                              <h4 className="text-lg font-bold text-green-300 mb-3 text-center">(i) Form Acc. 9-Summary</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-purple-400/30">
                              <h4 className="text-lg font-bold text-purple-300 mb-3 text-center">(ii) Form Acc.9 (A)- List of members of the Committee and of other officials attending</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-yellow-400/30">
                              <h4 className="text-lg font-bold text-yellow-300 mb-3 text-center">(iii) Form Acc. 9 (B)- Descriptive account of the Accident</h4>
                            </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-red-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-red-400/30">
                              <h4 className="text-lg font-bold text-red-300 mb-3 text-center">(iv) Form Acc.9 (c) List of witnesses examined with their names, designation, and staff numbers / PF number</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-indigo-500/20 to-blue-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-indigo-400/30">
                              <h4 className="text-lg font-bold text-indigo-300 mb-3 text-center">(v) Form Acc.9 (D) and (E) – Deposition of witness</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-teal-500/20 to-cyan-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-teal-400/30">
                              <h4 className="text-lg font-bold text-teal-300 mb-3 text-center">(vi) Form Acc.9 (F) – Remarks and reasons for finding</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-orange-500/20 to-yellow-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-orange-400/30">
                              <h4 className="text-lg font-bold text-orange-300 mb-3 text-center">(vii) Form Acc.9 (G) – joint finding</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-pink-500/20 to-rose-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-pink-400/30">
                              <h4 className="text-lg font-bold text-pink-300 mb-3 text-center">(viii) Form Acc.9 (H) – Matters brought to light during the inquiry</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-cyan-400/30">
                              <h4 className="text-lg font-bold text-cyan-300 mb-3 text-center">(ix) Form Acc.9 (I) – Suggestions & Recommendations</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-emerald-500/20 to-green-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-emerald-400/30">
                              <h4 className="text-lg font-bold text-emerald-300 mb-3 text-center">(x) Form Acc.9 (J) – Adequacy or otherwise of rescue and relief measures, etc.</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-violet-500/20 to-purple-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-violet-400/30">
                              <h4 className="text-lg font-bold text-violet-300 mb-3 text-center">(xi) Form Acc.9 (k) – Composition, marshalling order and particulars of rolling stock on the train involved</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-amber-500/20 to-yellow-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-amber-400/30">
                              <h4 className="text-lg font-bold text-amber-300 mb-3 text-center">(xii) Form Acc.9(L) – Details of photographs taken at the site of accident</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-rose-500/20 to-pink-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-rose-400/30">
                              <h4 className="text-lg font-bold text-rose-300 mb-3 text-center">(xiii) Form Acc.9 (M) – Details of damages to engine and rolling stock and approximate cost thereof</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-sky-500/20 to-blue-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-sky-400/30">
                              <h4 className="text-lg font-bold text-sky-300 mb-3 text-center">(xiv) Form Acc.9 (N) – Details of damages to permanent way and approximate cost thereof</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-lime-500/20 to-green-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-lime-400/30">
                              <h4 className="text-lg font-bold text-lime-300 mb-3 text-center">(xv) Form Acc.9 (O) – Details of damages to signal interlocking and communication gear and approximate cost thereof</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-fuchsia-500/20 to-purple-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-fuchsia-400/30">
                              <h4 className="text-lg font-bold text-fuchsia-300 mb-3 text-center">(xvi) List of passengers and / or railway employees injured or killed,and their disposal and the particulars of ex-gratia payment made</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-slate-500/20 to-gray-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-slate-400/30">
                              <h4 className="text-lg font-bold text-slate-300 mb-3 text-center">(xvii) A detailed dimensional sketch illustrative of the accident</h4>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div className="space-y-4">
                            <div className="bg-gradient-to-r from-stone-500/20 to-gray-500/20 lg:p-4 py-3 lg:px-4 px-2 rounded-xl border border-stone-400/30">
                              <h4 className="text-lg font-bold text-stone-300 mb-3 text-center">(xviii) Pro-forma as stipulated in Appendix IV in case of derailments</h4>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMChapaterPage107
