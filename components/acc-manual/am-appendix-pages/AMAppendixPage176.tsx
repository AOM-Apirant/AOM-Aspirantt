      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-orange-300 mb-4">PENALTIES FOR SERVING RAILWAY EMPLOYEES</h2>
                    ...
                    <div className="flex-1">
                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <p className="text-gray-200">The Penalties are classified into two categories - Minor and Major. There are six minor penalties and five major penalties, as listed below: —</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Minor Penalties:</h4>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <ul className="space-y-1">
                              ...
                              <li>• (iii-a) Withholding of the Privilege Passes or Privilege Ticket Orders or both;</li>
                              <li>• (iii-b) Reduction to a lower stage in the time scale of pay for a period not exceeding three years, without cumulative effect and not adversely affecting his pension.</li>
                              <li>• (iv) Withholding of increments of pay for a specified period with further directions as to whether on the expiry of such period, this will or will not have the effect of postponing the future increments of pay.</li>
                            </ul>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Major Penalties:</h4>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <ul className="space-y-1">
                              ...
                              <li>• (viii) Removal from service which shall not be a disqualification for future employment under the government or Railway Administration;</li>
                              <li>• (ix) Dismissal from service which shall ordinarily be a disqualification for future employment under the Government or Railway Administration.</li>
                            </ul>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage176