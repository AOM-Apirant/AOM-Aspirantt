      ...
      <div className="relative z-10 py-6 lg:px-4 px-2">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="lg:text-4xl text-2xl font-bold text-orange-300 mb-4">ANNEXURE &apos;A&apos;</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-orange-600 mx-auto mb-6 rounded-full"></div>
            <p className="lg:text-xl text-base text-gray-200 max-w-4xl mx-auto leading-relaxed">
              LIST OF ZONES ON S.C.RAILWAY WITH THEIR AREAS COVERED BY EACH ZONE WHICH WARNING MESSAGES ARE ISSUED
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Zone I</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">State & District:</h5>
                          <p className="text-gray-200">Maharashtra - Manmad, Nasik, Mudkhed, Aurangabad, Adilabad, Parbhani, Parbhani, Nanded and Parlivaijnath, Osmanabad</p>
                          <p className="text-gray-200">Maratwada region - Akola of Vidharbha Region</p>
                          <p className="text-gray-200">Madhya pradesh State - Khandwa District</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Railway Section:</h5>
                          <p className="text-gray-200">Purna-Akola-Khandwa</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Official Address:</h5>
                          <p className="text-gray-200">Chief Controller, Operating Branch, Control Office, Nanded Division, S.C.Railway Nanded, Maharashtra</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Contact Details:</h5>
                          <p className="text-gray-200">Telephone: 02462-261729</p>
                          <p className="text-gray-200">Email: drmned@scr.railnet.gov.in</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Regional Meteorological Centre:</h5>
                          <p className="text-gray-200">Kamalnagar, Parlivaijnath</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Zone II</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">State & District:</h5>
                          <p className="text-gray-200">Andhra Pradesh</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Railway Section:</h5>
                          <p className="text-gray-200">Basar, Purna-Akola-Dist. of Khandwa</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Official Address:</h5>
                          <p className="text-gray-200">Chief Controller, Regional Control Office, Secunderabad division, Sanchalan Bhavan, S.C.Railway, Secunderabad-500 071</p>
                          <p className="text-gray-200">Chief Controller, Control Office Hyderabad Divn, Hyderabad Bhavan, S.C.Railway, Secunderabad-500 071</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Contact Details:</h5>
                          <p className="text-gray-200">Telephone: 040-27823156, 040-27823905, 8393473, 8394105, 26823009</p>
                          <p className="text-gray-200">Email: drmsc.railnet.gov.in</p>
                        </div>

                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <h5 className="text-orange-300 font-semibold mb-2">Regional Meteorological Centre:</h5>
                          <p className="text-gray-200">Regional Meteorological Centre Colaba, Mumbai-400 005</p>
                          <p className="text-gray-200">Telephone: 022-8393473</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-orange-900/30 to-red-900/30 p-5 rounded-xl border border-orange-400/20 shadow-lg">
                  ...
                  <div className="space-y-3 mt-4">
                    <div>
                      ...
                      <span className="text-gray-200 ml-2">Andhra Pradesh - Adilabad, Karimnagar, Nizamabad, Warangal, Medak</span>
                    </div>
                    <div>
                      <span className="font-semibold text-orange-200">Railway Sections:</span>
                      <span className="text-gray-200 ml-2">Kazipet–Balharshah, Kazipet–Dornakal, Aler–Kazipet, Sadasivpet Road–Zahirabad, Manikgarh–Gadchandur, Peddapalli–Karimnagar, Masaipet–Basar</span>
                    </div>
                    <div>
                      <span className="font-semibold text-orange-200">Control Offices:</span>
                    ...
                    <div>
                      <span className="font-semibold text-orange-200">Meteorological Centres:</span>
                      <ul className="list-none ml-0 mt-2 space-y-1">
                        <li className="flex items-start gap-2">
              ...
              <div className="mt-8">
                <span className="text-orange-200 font-semibold text-lg">Rayalaseema Region (Andhra Pradesh)</span>
              ...
              <div className="mt-10 space-y-8">
                <div>
                  <span className="text-orange-200 font-semibold text-lg">South Coastal Andhra Region</span>
                  <div className="ml-4 mt-2 space-y-3">
                    ...
                    <div>
                      <span className="font-semibold text-orange-200">Control Office:</span>
                      <ul className="list-none ml-0 mt-2 space-y-1">
                        <li className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-gradient-to-r from-orange-500 to-red-600 rounded-full text-white text-xs flex items-center justify-center font-bold">★</span>
                          <span className="text-gray-200">
                    ...
                    <div>
                      <span className="font-semibold text-orange-200">Meteorological Centre:</span>
                      <ul className="list-none ml-0 mt-2 space-y-1">
                        <li className="flex items-start gap-2">
                          <span className="w-5 h-5 bg-gradient-to-r from-orange-500 to-red-600 rounded-full text-white text-xs flex items-center justify-center font-bold">☁️</span>
                          <span className="text-gray-200">
                ...
                <div>
                  <span className="text-orange-200 font-semibold text-lg">Nalgonda and Kurnool Districts</span>
                  <div className="ml-4 mt-2 space-y-3">
                    <div>
                      <span className="font-semibold text-orange-200">Railway Sections:</span>
                      <span className="text-gray-200 ml-2">
              ...
              <div className="mt-8 space-y-8">
                <div>
                  <h3 className="text-orange-300 font-bold text-lg mb-2 flex items-center gap-2">
                    <span className="w-7 h-7 bg-gradient-to-r from-orange-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold">VI</span>
                    Andhra Pradesh State (Visakhapatnam, East Godavari, West Godavari, and Krishna Districts of North Coastal Andhra Region)
                  </h3>
                  <div className="ml-4 space-y-2">
                    <div>
...
export default AMAppendixPage163