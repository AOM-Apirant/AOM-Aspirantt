                ...
                <div className="text-gray-200 lg:text-lg text-base leading-relaxed text-left mb-6 max-w-4xl mx-auto space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">NDRF was constituted with 8 Battalions of Central Police Force, i.e., two Battalions from Border Security Force (BSF), two from Central Industrial Security Force (CISF), two from Indo-Tibetan Border Police (ITBP) and two from Central Reserve Police Force (CRPF) are earmarked for this purpose.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">The NDRF was constituted for the purpose of specialist response to disaster situations.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">The general superintendence, direction and control of the Force shall be vested in the NDMA and the command and supervision of the force shall vest in the DG, Civil Defense and NDRF.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">A total of 144 specialist response teams constituting 45 personnel each are functioning in NDRF.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">43 specialist response teams are trained to respond to natural calamities, 72 teams for responding to nuclear, biological and chemical (NBC) related emergencies.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-gray-200 leading-relaxed">Four National level Training Institutes (one each at BSF, CISF, CRPF & ITBP) are being developed as nodal institutes for training of teams. One team in each Battalion will also be trained in deep sea diving for the purpose of search and rescue during floods and cyclones.</p>
                      </div>
                    </div>
                  </div>
...
export default AMAppendixPage136
