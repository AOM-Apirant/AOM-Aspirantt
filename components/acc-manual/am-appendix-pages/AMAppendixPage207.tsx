                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc.11</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="text-center font-semibold text-lg mb-2">
                              Casualties – Persons Run over:
                            </div>
                            <div className="text-center">
                              Statement of Class P.2 accidents for the month of ....................... 20
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Kilometerage and Station at /or stations between which the accident occurred.</div>
                              <div className="text-center">3</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Number & description of train</div>
                              <div className="text-center">4</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Whether the engine was provided with electric head light and it was in working order</div>
                              <div className="text-center">5</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Whether the site of the accident is on the straight or on a curve and visibility of site (in telegraph posts) for Loco Pilot</div>
                              <div className="text-center">6</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Whether the site of the accident is a level crossing and, if so whether it is manned. If the site of the accident is not a level crossing, the kilometreage of the nearest level crossing</div>
                              <div className="text-center">7</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">(a) Particulars of fencing at the site of accident (b) Any other relevant particulars regarding site of accident</div>
                              <div className="text-center">8</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Brief particulars as to how the accident occurred with name, sex, and address of person(s) killed or injured</div>
                              <div className="text-center">9</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">(a) Whether the Loco Pilot noticed the accident or not (b) Particulars of blood marks</div>
                              <div className="text-center">10</div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div className="font-semibold">Verdict at inquest</div>
...
export default AMAppendixPage207