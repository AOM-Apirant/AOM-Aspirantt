        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Form Acc. 9-J<br />Relief measures:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <h5 className="text-lg font-semibold">Relief Measures</h5>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              {/* Relief Measures Details Section */}
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-gradient-to-r from-red-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Relief Measures Details:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              <strong>1.</strong> Train and date…………………………………………
                            </div>
                            <div>
                              <strong>2.</strong> Kilometreage and section………………………………..
                            </div>
                            <div>
                              <strong>3.</strong> First information report received from…………………………………………… by……………………………………………… at……………………………………………….
                            </div>
                            <div>
                              <strong>4.</strong> Time of accident and weather condition……….</div>
                            <div>
                              <strong>5.</strong> Casualties
                            </div>
                            <div className="ml-4">
                              Injured………………………………………………… Public Staff Removed to Hospital Dead
                            </div>
                            <div>
                              <strong>6.</strong> Nearest Hospital Place Distance
                            </div>
                            <div>
                              <strong>7.</strong> Medical Relief trains Ordered at………..</div>
                            <div>
                              <strong>8.</strong> Accident Relief train Ordered at…………</div>
                            <div>
                              <strong>9.</strong> Relief special Ordered at………… Left at Arrived to site at………… Left at………………... Arrived to site at………… Left at………………… Arrived to site at…………</div>
                            <div>
                              <strong>10.</strong> Transshipment ordered at
                            </div>
                            <div>
                              <strong>11.</strong> Trains transshipped No. Time.
                            </div>
                            <div>
                              <strong>12.</strong> Trains cancelled
                            </div>
                            <div>
                              <strong>13.</strong> Trains diverted, routed via
                            </div>
                            <div>
                              <strong>14.</strong> Trains detained No. Minutes
                            </div>
                            <div>
                              <strong>15.</strong> Probable cause and given by
                            </div>
                            <div>
                              <strong>16.</strong> Obstruction cleared at
                            </div>
                            <div>
                              <strong>17.</strong> Through running restored at
                            </div>
                            <div>
                              <strong>18.</strong> Any other details
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage202
