          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl py-3 lg:px-4 px-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
            <div className="space-y-8">
              ...
              <div className="text-gray-200 text-center py-8">
                4 Sections relating to Accidents:
...
Where no inquiry is held by the Commissioner under sub-section (1) of Section 114 or where the Commissioner has informed the railway administration under sub-section
...
Section 116: Powers of Commissioner in relation to Inquiries For the purpose of conducting an inquiry under this Chapter into the causes of any accident on a railway, the Commissioner shall, in addition to the powers specified in Section 7, have the powers as are vested in a civil Court while trying a suit under the Code of Civil Procedure, 5 of 1900, in respect of the following matters, namely:-
a. summoning and enforcing the attendance of persons and examining them on oath;
b. requiring the discovery and production of documents;
c. receiving evidence on affidavits;
d. requisitioning any public record or copies thereof from any Court or office;
e. any other matter which may be prescribed.
The Commissioner while conducting an enquiry under this Chapter shall be deemed to be a Civil Court for the purpose of section 195 and Chapter XXVI of the code of criminal procedure, 1973 (2 of 1974)
Section 117: Statement made before Commissioner – No statement made by a person in the course of giving evidence in an inquiry before the Commissioner shall subject him to, or be used against him in, any civil or criminal proceeding, except a prosecution for giving false evidence by such statement:
