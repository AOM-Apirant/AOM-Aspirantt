                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Specimen Form ACC 6-D<br />Eye witness Statement:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-center text-gray-200 space-y-2">
                            <p><strong>Form &lsquo;C&rsquo; Serial No. &lsquo;C&rsquo;</strong></p>
                            <p><strong>Eye Witness Statement</strong></p>
                            <p><strong>(Use one form only for each person)</strong></p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 lg:p-6 py-3 lg:px-4 px-2 rounded-xl border border-red-400/20 hover:border-red-400/30 transition-all duration-300">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-red-300 mb-4">Eye Witness Details:</h4>

                      <div className="space-y-4">
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-3">
                            <div>
                              <strong>1.</strong> Name of eye-witness……………………………………….…………………………
                            </div>
                            <div>
                            ...
                            <div>
                              <strong>4.</strong> Occupation…………………………………………………………..…………………</div>
                            <div>
                              <strong>5.</strong> Address…………………………………………………………………………………</div>
                            <div>
                              <strong>6.</strong> Carriage in which traveling at the time of accident ……….………………………
                            </div>
                            <div>
                              <strong>7.</strong> Particulars of ticket held
                            </div>
                            <div className="ml-4">
                              From………………………………To…………………………………..……………. Class………………………………..Ticket No…………………………………...….. Date………………………………………………………………………….………….
                            </div>
                            <div>
                              <strong>8.</strong> Time, date and place of accident
                            </div>
                            <div className="ml-4">
                              Time………………………………………..Date…………………………………….. Place……………………………………………………………………………………
                            </div>
                            <div>
                              <strong>9.</strong> Description of accident………………………………………………………………..
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-red-900/20 p-4 rounded-lg border border-red-400/20">
                          <div className="text-gray-200 space-y-2">
                            <div className="border-t border-gray-600 pt-2">
                              ...
                              <p><strong>Date……………………</strong> <strong>Signature of eye-witness</strong></p>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default AMAppendixPage190A
