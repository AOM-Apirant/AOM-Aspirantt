                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 ml-4">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-gray-300 leading-relaxed">Regional Meteorological Centre, Colaba Bombay for Zone I.</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span className="text-white font-bold text-sm">ii</span>
                          </div>
                          <p className="text-gray-300 leading-relaxed">State Meteorological Centre, Hyderabad Air Port, Hyderabad for Zones II, III and IV.</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span className="text-white font-bold text-sm">iii</span>
                          </div>
                          <p className="text-gray-300 leading-relaxed">Cyclone warning centre, Andhra University Campus, Visakhapatnam for zones V & VI.</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span className="text-white font-bold text-sm">iv</span>
                          </div>
                          <p className="text-gray-300 leading-relaxed">State Meteorological Centre,H.A.L. Air Port, Bangalore for Zone VII.</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default AMAppendixPage156C