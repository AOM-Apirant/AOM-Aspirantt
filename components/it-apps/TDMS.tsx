      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg py-8 pl-8 pr-2 hover:shadow-xl transition-shadow">
            <div className="bg-yellow-100 text-yellow-600 p-3 rounded-full mb-4 inline-block">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Milestones Section */}
        <div className="bg-white rounded-xl shadow-lg py-8 pl-8 pr-2 mb-8">
          <h2 className="lg:text-2xl text-xl font-semibold text-gray-800 mb-6 text-center">Milestone</h2>
