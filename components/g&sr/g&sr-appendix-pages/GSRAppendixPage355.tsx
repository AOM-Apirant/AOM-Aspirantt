                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                        ...
                        <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                          <div className="space-y-4 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                            <p>
                              <span className="font-semibold text-white/90">1.</span> At &apos;Notice Stations&apos;, instead of preserving train-wise record copies, one master copy of
                              Caution Order for each direction for each day (duly maintaining the changes if any)
                              should be preserved.
                            </p>
                            <p>
                              <span className="font-semibold text-white/90">2.</span> At Notice Stations/Crew control lobbies&apos;, acknowledgement of Loco Pilot / Co–Loco
                              Pilot, Assistant Loco Pilot (Loco Pilot and Assistant Loco Pilot of assisting engine /
                              banking engine etc.) and Guard may be obtained in a separate register maintained
                              direction-wise.
                            </p>
                            <p>
                              <span className="font-semibold text-white/90">3.</span> Record foils of the Caution Orders shall be preserved for a period of six months after
                              use
                            </p>
                          </div>
                        </div>
