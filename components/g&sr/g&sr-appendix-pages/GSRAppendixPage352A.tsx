                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90">
                      Method of obtaining acknowledgement from the Station Master of &apos;Notice Station&apos;:
                    </p>
                    <div className="space-y-4 lg:space-y-5">
                      {[
                        { 
                          num: 1, 
                          text: "When the „Notice Station‟ is situated in the same control section: The Station Master of the block station controlling the entry of the train into the section where speed restrictions are to be observed / modified, shall call upon the Station Master of the „Notice Station‟ concerned and transmit the message notifying / modifying the speed restrictions supported by a private number and initials. The Station Master of „Notice Station‟ shall acknowledge the same supported by a private number and initials. In case of notification of a new restriction or modification of an existing one, the Station Master of „Notice Station‟ shall also indicate the number and description of the first train to which such Caution Order / modified Caution Order will be issued. Where auto phones are provided, these messages may be exchanged by Station Masters duly advising the SCOR. Accordingly, the SCOR shall then issue a Control Order to the Station Master of the block station immediately in rear of the affected block section, indicating the number and description of all trains which are on the run between the „Notice Station‟ and such block station, to which Caution Order shall be issued."
                        },
                        { 
                          num: 2, 
                          text: "When the „Notice Station‟ is situated on a different Control Section/different Division: The Station Master of the block station controlling the entry of the train into the section where speed restrictions are to be observed/modified shall inform this with his initials and private number to the SCOR of his section. It is the responsibility of the SCOR to inform this message to the „Notice Station‟ along with initials and private number and obtain the acknowledgement with initials and private number from Station Master of „Notice Station‟ of next control section/division. And then SCOR shall inform these initials and private number along with a Control Order to the Station Master of the block station immediately in rear of the affected block section, indicating the number and description of all trains which are on the run between the „Notice Station‟ and such block station, to which Caution Order shall be issued. Where auto phones are provided, these messages may be exchanged by Station Masters duly advising the SCOR."
                        }
                      ].map((item, index) => (
...
export default GSRAppendixPage352A