                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    ...
                    <div className="space-y-4 lg:space-y-5">
                      {[
                        { 
                          num: 1, 
                          text: "Caution Order forms should be serially numbered and the name of the station issuing it shall be stamped on each copy."
                        },
                        { 
                          num: 2, 
                          text: "A Caution Order should have space enough at least for four restrictions. No entries should be made on the back side of the Caution Order sheet. If more than one Caution Order form is used, pages should be serially numbered as Page-1, Page-2, page-3 etc."
                        },
                        { 
                          num: 3, 
                          text: "It shall specify the kilometreage, the station at which or the stations between which caution is required to be observed, the reasons there for and the speed at which the train will travel on the restricted length. Names of the stations concerned should be written in full. Codes should not be used. The Caution Order should have all the speed restrictions (permanent and temporary) in force in a geographical order in relation to the direction of movement upto the next „Notice Station‟."
                        },
                        { 
                          num: 4, 
                          text: "Caution Order shall be specifically made out for each train. They shall be on white paper in blue or black font or typed or made out on computers with the words 'Caution Order' written on top of the form in bold letters of appropriate font size to draw attention distinctly and signed in full. The Typed/Cyclostyled/ Computer printed Caution Orders are supplied to 'Notice Stations'/train ordering stations/end cabins/bye-pass cabins/any other station nominated for this purpose. Such Caution Orders shall be checked up by the Station Master before delivering to ensure that all the restrictions in force have been incorporated therein. The details such as total number of Caution Orders in force, number of additions and deletions shall also be indicated in those Caution Orders. Wherever speed restrictions are required to be observed at two or more locations in the same block section, the kilometre of all such stations shall be indicated in geographical order in relation to the direction of movement."
                        },
                        { 
                          num: 5, 
                          text: "It shall always be dated and signed in full by Station Master or any other such staff as authorized by Sr.DOM / DOM from time to time."
                        },
                        { 
                          num: 6, 
                          text: "In case of any error or overwriting, it shall be cancelled and a fresh one prepared and issued."
                        }
                      ].map((item, index) => (
...
export default GSRAppendixPage352C