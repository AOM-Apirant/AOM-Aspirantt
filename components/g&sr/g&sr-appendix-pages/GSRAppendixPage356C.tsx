                ...
                <div className="group relative flex flex-col gap-6 rounded-xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-950/70 to-blue-950/70 p-3 lg:p-10 transition-all duration-500 hover:border-white/20 hover:bg-gradient-to-br hover:from-slate-900/80 hover:via-indigo-950/80 hover:to-blue-950/80">
                  ...
                  <div className="pt-14 lg:pt-10 space-y-6 text-blue-100/90 leading-relaxed tracking-wide">
                    <p className="font-semibold text-lg lg:text-2xl text-white/90 mb-6">
                      These instructions should be read together with provisions in General & Subsidiary Rules.
                    </p>
                    ...
                    <div className="space-y-6">
                            ...
                            <table className="w-full border-collapse">
                              <thead>
                                <tr className="border-b border-white/10">
                                  ...
                                  <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Subject</th>
                                  <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Details</th>
                                </tr>
                              </thead>
                              <tbody className="text-blue-100/90">
                                {[
                                  { num: "1.", subject: "Number of LC Gate", details: "" },
                                  { num: "2.", subject: "Engineering or Traffic Gate", details: "" },
                                  { num: "3.", subject: "Under control of PWI/SM", details: "" },
                                  { num: "4.", subject: "Location (Km)", details: "" },
                                  { num: "5.", subject: "At station", details: "" },
                                  { num: "6.", subject: "Stations on either side", details: "" },
                                  { num: "7.", subject: "BG/MG", details: "" },
                                  { num: "8.", subject: "Single line/Twin single line/Double line/Multiple line", details: "" },
                                  { num: "9.", subject: "Normal position", details: "" },
                                  { num: "10.", subject: "Interlocked/non-interlocked", details: "" },
                                  { num: "11.", subject: "Means of interlocking", details: "" },
                                  { num: "12.", subject: "Provision of Gate signals (at Kms.) Up:", details: "Down:" },
                                  { num: "13.", subject: "Signalling arrangements", details: "" },
                                  { num: "14.", subject: "Means of communication (Telephone / Bell etc.)", details: "" },
                                  { num: "15.", subject: "Width of the Level Crossing Gate", details: "" },
                                  { num: "16.", subject: "Type of road (NH/SH/Others)", details: "" },
                                  { num: "17.", subject: "Name of road", details: "" },
                                  { num: "18.", subject: "Metal/non-metal", details: "" },
                                  { num: "19.", subject: "Approach road", details: "" },
                                  { num: "20.", subject: "Width of the road", details: "" },
                                  { num: "21.", subject: "Angle of road crossing (in case of the skew gates)", details: "" },
                                  { num: "22.", subject: "Road gradient (if any) (i) North/East:", details: "(ii) South/West:" },
                                  { num: "23.", subject: "Road Alignment (Straight/Curve) (iii) North/East:", details: "(iv)South/West:" },
                                  { num: "24.", subject: "Provision of height gauges", details: "" },
                                  { num: "25.", subject: "Type of barriers", details: "" },
                                  { num: "26.", subject: "Length of check rails", details: "" },
                                  { num: "27.", subject: "Road surface in between LC gates", details: "" },
                                  { num: "28.", subject: "Length of rumble strips/speed breakers", details: "" },
                                  { num: "29.", subject: "Road signs", details: "" },
                                  { num: "30.", subject: "Speed breaker indication board", details: "" },
                                  { num: "31.", subject: "No. of TVUs and Date of last Census taken", details: "" },
                                  { num: "32.", subject: "Date of next Census due", details: "" },
                                  { num: "33.", subject: "Demarcation for placement of detonators", details: "" },
                                  { num: "34.", subject: "Number of Gatemen working", details: "" },
                                  { num: "35.", subject: "Nearest railway medical assistance", details: "" },
                                  { num: "36.", subject: "Nearest private medical assistance available (if any)", details: "" },
                                  { num: "37.", subject: "List of equipment available yes/no", details: "" },
                                ].map((row, index) => (
                                  <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.num}</td>
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.subject}</td>
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.details}</td>
                                  </tr>
                                ))}
                              </tbody>
                            </table>
                          ...
                          <div className="relative overflow-x-auto rounded-2xl bg-slate-900/50">
                            <table className="w-full border-collapse">
                              <thead>
                                <tr className="border-b border-white/10">
                                  <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">S. No.</th>
                                  <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Items</th>
                                  <th className="px-4 py-3 text-left text-sm font-semibold text-white/90 lg:text-base">Quantity/Numbers</th>
                                </tr>
                              </thead>
                              <tbody className="text-blue-100/90">
                                {[
                                  { num: "1.", item: "Hand Signal lamp tri colour", qty: "3 (5 on quadruple/twin single line section)" },
                                  { num: "2.", item: "Hand Signal flag – green", qty: "1 mounted on stick" },
                                  { num: "3.", item: "Hand Signal flags – red", qty: "3 mounted on sticks (6 on quadruple/twin single line section and 7 on hexaple section)" },
                                  { num: "4.", item: "Banner flags – Red", qty: "3 (5 on quadruple/twin single line section)" },
                                  { num: "5.", item: "Posts for exhibiting red banner flag", qty: "2 (4 on quadruple/twin single line section/ 5 on Hexaple section)" },
                                  { num: "6.", item: "Spare chains with padlocks", qty: "2 with stop mark" },
                                  { num: "7.", item: "Detonators", qty: "10" },
                                  { num: "8.", item: "Gate lamps", qty: "2" },
                                  { num: "9.", item: "Tommy bar", qty: "1" },
                                  { num: "10.", item: "Mortar pan", qty: "1" },
                                  { num: "11.", item: "Spade/faurah", qty: "1" },
                                  { num: "12.", item: "Rammer", qty: "1 (In case of asphalted road, this may not be provided)" },
                                  { num: "13.", item: "Pick axe", qty: "1 (In case of asphalted road, this may not be provided)" },
                                  { num: "14.", item: "Tin case for flags", qty: "1" },
                                  { num: "15.", item: "Can for oil", qty: "1" },
                                  { num: "16.", item: "Water pot/Bucket", qty: "1" },
                                  { num: "17.", item: "Canister for muster roll", qty: "1" },
                                  { num: "18.", item: "Set of spare spectacles of gateman wearing glasses.", qty: "1" },
                                  { num: "19.", item: "Board demarcating protection of LC gate diagram in case of obstruction on gate", qty: "1" },
                                  { num: "20.", item: "Basket", qty: "1" },
                                  { num: "21.", item: "Whistle", qty: "1" },
                                  { num: "22.", item: "Wall clock", qty: "1" },
                                  { num: "23.", item: "Small size chains with padlocks (for locking Gate Booms/Gate Leaves).", qty: "2" },
                                ].map((row, index) => (
                                  <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.num}</td>
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.item}</td>
                                    <td className="px-4 py-3 text-sm lg:text-base">{row.qty}</td>
                                  </tr>
                                ))}
                              </tbody>
                            </table>
                      ...
                      <div className="space-y-4">
                        <p className="font-semibold text-base lg:text-lg text-white/90">
                          1.6. Normal Position of LC gates
                        </p>
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                      ...
                      {/* 1.7 Gate Working Rules */}
                      <div className="space-y-4">
                        <p className="font-semibold text-base lg:text-lg text-white/90">
                          1.7. Gate Working Rules for Engineering LC Gates:
                        </p>
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>
                                The instructions for working of the level crossings, situated outside Stop signals (including the working of bell and/or telephone communications with station, if provided) and also for the procedure to be followed by the Gateman to protect the line, if an obstruction is caused at the level crossing, shall be issued by the Engineering branch and a copy is kept at the gate lodge. Where a level crossing is equipped with gate signals, a copy of the signalling and interlocking diagram shall also be posted at the gate lodge.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="space-y-4">
                        <p className="font-semibold text-base lg:text-lg text-white/90">
                          1.8. Gateman&apos;s action in case of train parting:
                        </p>
                        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-blue-900/20 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/10">
                          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-indigo-600/10 opacity-0 transition-opacity duration-500 hover:opacity-100"></div>
                          <div className="relative flex flex-col gap-5 rounded-2xl bg-slate-900/50 px-5 py-6 lg:px-8 lg:py-8">
                            <div className="space-y-3 text-base leading-relaxed text-blue-100/90 lg:text-lg">
                              <p>
                                If a Gateman observes a train running in two or more portions, he shall draw the attention of the Loco Pilot, Guard or Brakes-man by shouting and/or by whistling. He shall also show green hand signal during day and white light during night waving up and down vertically as high and as low as possible. He shall in no case show the red signal. Should he fail to attract the attention of the Loco Pilot and if there is sufficient distance between the parted portions of the train, he must place 3 detonators on the line, 10 metres apart for the following portion or portions to attract the attention of the Guard. Gateman shall also look out for the tail board or tail lamp, as the case may be and advise the Station Master, if telephone communication is provided.
                              </p>
                            </div>
                          </div>
                        </div>
...
export default GSRAppendixPage356C
