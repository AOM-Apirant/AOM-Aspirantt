...
import { BookOpen, Layers, Users, RadioTower, TrainFront, Building2, AlertTriangle, GitBranch, Blocks, Workflow, ArrowRightLeft, Shield, Ticket, LifeBuoy, CircuitBoard, Hammer, Fence, Zap, Puzzle, ChevronDown, ChevronUp } from "lucide-react"
                    ...
                    <div className="grid gap-3">
                      {chapter.rules.map((rule, index) => (
                        <div
                          ...
                          className="bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 px-4 py-3"
                        >
                          <p className="text-gray-200 whitespace-pre-line text-base lg:text-lg leading-relaxed">{rule}</p>
                        </div>
                      ))}
                    </div>
                  </div>
