        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <div className="mt-8 inline-flex items-center justify-center">
              <div className="relative">
                <div className="lg:w-24 lg:h-24 w-16 h-16 bg-gradient-to-br from-cyan-400/50 via-indigo-500/50 to-blue-500/50 rounded-full blur-xl"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="lg:w-20 lg:h-20 w-12 h-12 rounded-full border border-white/10 bg-gradient-to-br from-blue-700/60 to-indigo-800/60 backdrop-blur">
                    <div className="w-full h-full rounded-full border border-white/20 flex items-center justify-center">
                      <span className="lg:text-2xl text-lg font-bold text-white/90">1.03</span>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <p className="mt-6 text-xl lg:text-3xl font-semibold text-indigo-100/90">
