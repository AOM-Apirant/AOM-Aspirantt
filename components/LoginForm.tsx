  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-700 text-md font-medium italic">
      ...
      <div className="mb-8">
        <div className="snake-border">
          <button
            ...
            className="group relative w-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white py-5 px-6 rounded-full font-semibold hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 transform hover:scale-[1.02] transition-all duration-300 flex items-center justify-center space-x-4 touch-button focus-ring overflow-hidden backdrop-blur-sm"
          >
            {/* Animated background gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></div>
        ...
        <p className="text-center text-sm text-gray-500 mt-4 font-medium">
          Please sign in to explore more ahead of you
        </p>
      </div>
