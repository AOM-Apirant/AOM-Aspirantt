    ...
    <div className="w-full">
      ...
      <div className="mb-6">
        <button
          ...
          className="w-full bg-white border border-gray-400 text-gray-700 py-4 px-4 rounded-lg font-medium hover:bg-gray-50 transform hover:scale-[1.02] transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center space-x-3 touch-button focus-ring"
        >
